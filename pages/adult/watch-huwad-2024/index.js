...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/adult/watch-huwad-2024',
    name: 'Watch Adult Huwad (2024) | JWF™',
    alternateName: [
      'Ver Huwad Parte (2024) para adultos | JWF™',
      'Regarder Huwad Partie (2024) pour adultes | JWF™',
      'Huwad Teil (2024) für Erwachsene ansehen | JWF™',
      '观看 Huwad (2024) 成人内容 | JWF™',
      'Huwad パート (2024) 大人向け | JWF™',
      'Huwad 파트 (2024) 성인 전용 | JWF™',
      'Assistir Huwad Parte (2024) para adultos | JWF™',
      'Guarda Huwad Parte (2024) per adulti | JWF™',
      'Посмотреть Huwad Часть (2024) для взрослых | JWF™',
      'مشاهدة Huwad (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Huwad (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedAdult = data.find(adult => adult.id === 'INDEX02')
  return {
    props: {
      adult: selectedAdult
    }

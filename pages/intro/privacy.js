...
const Privacy = () => {
  ...
  return (
    <div>
       <Head>
        <title>Just Watch Free™ | Privacy Policy</title>
        ...
        <link
          ...
          />
          <link rel='canonical' href='https://justwatchfree.vercel.app/privacy/' />
          ...
          />
          <meta property='og:url' content='https://justwatchfree.vercel.app/privacy/' />
          <meta
...
<section className="mb-32 text-gray-800">
  <div className="flex flex-wrap">
    <div className="grow-0 shrink-0 basis-auto mb-12 md:mb-0 w-full  px-3 lg:px-6">
      ...
      <p className="font-bold mb-2">Just Watch Free™ </p>
      <p className="text-gray-500 mb-6">
      Just Watch Free™ International(Just Watch Free™) is committed to protecting your privacy. This Privacy Policy applies only to the Web Sites and applications published by Just Watch Free™ International.
      </p>
      <p className="font-bold mb-2">Note: Use of Information</p>
      <p className="text-gray-500 mb-6">
      Information that we collect  </p>
      <p className="text-gray-500 mb-6">
      Just Watch Free™ may collect information from its users in three different ways: directly from the user, from traffic references of hostingservers and from cookies.
      </p>
     ...
     2. As otherwise described to you at the point of collection or with your consent.  
      ...
      We do not make warranties that this site will operate error free. If you see an error, please contact the <a className="font-bold text-blue-500 mb-6" href="mailto:ytmagpublisher@outlook.com ">webmaster</a>. By entering this site you agree to hold the owners, employees, advertisers of Just Watch Free™  free from any and all liability.This site (Just Watch Free™ ) do not offer any membership.If you have any questions please feel free to <a className="font-bold text-blue-500 mb-6" href="mailto:ytmagpublisher@outlook.com">contact us</a>.
      </p>
    </div>

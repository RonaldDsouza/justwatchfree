  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        url: tvshow.siteurl,
        name: `${tvshow.name} | Just Watch Free™`,
      ...
      },
      {
        ...
        headline: ` ${tvshow.name} | Just Watch Free™`,
        datePublished: tvshow.datePublished,
        dateModified: tvshow.dateModified,
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch The Ark Season 1 (2023) | JWF™</title>
          ...
          Next Episode {episode + 1 > videoSources.length ? 1 : episode + 1}
              ...
              >
                <iframe
                  ...
                  style={{
                      filter:
                      'contrast(1.0) saturate(1.0) brightness(1.0) hue-rotate(15deg)'
                  }}
                ></iframe>
                <p

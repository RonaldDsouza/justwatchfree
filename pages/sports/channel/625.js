...
const Ch01 = ({ sports }) => {
  ...
  return (
    <div>
      <Head>
        <title>Watch Cosmote Sport 4 HD | JWF™</title>
      ...
      >
        ...
        <h1 className='py-5 font-bold leading-none tracking-tight text-green-500 text-center text-3xl dark:text-white'>
          Watch Live Stream Cosmote Sport 4 HD
        </h1>
        <div
          style={{
            display: 'flex',
        ...
        <div className='flex flex-col text-blue-600 text-center items-center justify-center'>
          ...
          >
            <iframe
              ...
              marginHeight='0'
              marginWidth='0'
              src='https://dlhd.sx/embed/stream-625.php'
              name='iframe_a'
              scrolling='no'
              allowFullScreen
              width='100%'
...
export async function getServerSideProps () {
  ...
  const selectedSports = data.find(sports => sports.id === 'INDEX625')
  return {
    props: {

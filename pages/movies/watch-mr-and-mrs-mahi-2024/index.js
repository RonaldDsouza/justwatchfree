...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-mr-and-mrs-mahi-2024',
    name: 'Watch Movie Mr And Mrs Mahi (2024) | JWF™',
    alternateName: [
      'Ver película Mr And Mrs Mahi (2024) | JWF™',
      'Regarder le film Mr And Mrs Mahi (2024) | JWF™',
      'Film Mr And Mrs Mahi (2024) ansehen | JWF™',
      '观看电影 Mr And Mrs Mahi (2024) | JWF™',
      '映画 Mr And Mrs Mahi (2024) を見る | JWF™',
      '영화 Mr And Mrs Mahi (2024) 보기 | JWF™',
      'Assistir Filme Mr And Mrs Mahi (2024) | JWF™',
      'Guarda il film Mr And Mrs Mahi (2024) | JWF™',
      'Посмотреть фильм Mr And Mrs Mahi (2024) | JWF™',
      'مشاهدة فيلم Mr And Mrs Mahi (2024) | جي دبليو إف™'
    ]
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Mr And Mrs Mahi (2024) | JWF™</title>

...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://justwatchfree.vercel.app/adult/',
  headline: 'Watch Online Adult Content | JWF™',
  url: 'https://justwatchfree.vercel.app/adult/',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Adult',
      item: 'https://justwatchfree.vercel.app/adult/'
    }
  ]
})
...
const adultPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Online Adult Content | JWF™</title>
        <link rel='canonical' href='https://justwatchfree.vercel.app/adult/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Watch Online Adult |   Just Watch Free™' />
       ...
       <meta name="description" content="Stream HD movies and TV series for free on Just Watch Free. Explore, stream, and download full-length movies and shows in HD quality without registration."/>
        ...
        <meta property='og:url' content='https://justwatchfree.vercel.app/adult' />

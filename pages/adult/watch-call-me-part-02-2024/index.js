...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/adult/watch-call-me-part-02-2024',
    name: 'Watch Adult Call Me Part 02 (2024) | JWF™',
    alternateName: [
      'Ver Call Me Parte 02 (2024) para adultos | JWF™',
      'Regarder Call Me Partie 02 (2024) pour adultes | JWF™',
      'Call Me Teil 02 (2024) für Erwachsene ansehen | JWF™',
      '观看 Call Me 第02部分 (2024) 成人内容 | JWF™',
      'Call Me パート02 (2024) 大人向け | JWF™',
      'Call Me 파트 02 (2024) 성인 전용 | JWF™',
      'Assistir Call Me Parte 02 (2024) para adultos | JWF™',
      'Guarda Call Me Parte 02 (2024) per adulti | JWF™',
      'Посмотреть Call Me Часть 02 (2024) для взрослых | JWF™',
      'مشاهدة Call Me الجزء 02 (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Call Me Part 02 (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedAdult = data.find(adult => adult.id === 'INDEX16')
  return {
    props: {
      adult: selectedAdult
    }

...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-the-ark-season-1-tv-series',
    name: 'Watch The Ark Season 1 (2024) | JWF™',
    alternateName: [
      'Ver The Ark Temporada 1 (2024) | JWF™',
      'Regarder The Ark Saison 1 (2024) | JWF™',
      'The Ark Staffel 1 (2024) ansehen | JWF™',
      '观看黑暗物质 第一季 (2024) | JWF™',
      'ダークマター シーズン 1 (2024) を見る | JWF™',
      '다크 매터 시즌 1 (2024) 보기 | JWF™',
      'Assistir The Ark Temporada 1 (2024) | JWF™',
      'Guarda The Ark Stagione 1 (2024) | JWF™',
      'Посмотреть The Ark Сезон 1 (2024) | JWF™',
      'مشاهدة The Ark الموسم 1 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch The Ark Season 1 (2024) | JWF™</title>
  ...
  {tvshow.linkurl && (
    <Link href={tvshow.linkurl}>
      <div
        className={`px-4 py-2 border rounded mx-2 my-1 ${
          tvshow.linkurl ? 'bg-red-500 text-black' : 'bg-gray-200'
        } bg-blue-500 text-white rounded hover:bg-green-600 ml-4 text-xl hover:text-white`}
        style={{
          fontFamily: 'Poppins, sans-serif',
          marginTop: '20px',
...
export async function getServerSideProps () {
  ...
  const selectedTvshow = data.find(tvshow => tvshow.id === 'INDEX17')
  return {
    props: {

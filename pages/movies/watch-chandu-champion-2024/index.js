...
const moviesDetail = ({ movie }) => {
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      { text: 'Chandu Champion - 2024', url: 'https://www.imdb.com/title/tt27470893/' }
    ]
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        url: movie.siteurl,
        name: `${movie.name} | Just Watch Free™`,
      ...
      },
      {
        ...
        headline: ` ${movie.name} | Just Watch Free™`,
        datePublished: movie.datePublished,
        dateModified: movie.dateModified,
              ...
              <>
                ...
                >
                  ...
                  >
                    ...
                    <meta itemprop='uploadDate' content={movie.datePublished} />
                    <meta itemprop='thumbnailUrl' content={movie.backimage} />

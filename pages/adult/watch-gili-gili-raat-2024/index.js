...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/adult/watch-gili-gili-raat-2024',
    name: 'Watch Adult Gili Gili Raat (2024) | JWF™',
    alternateName: [
      'Ver Gili Gili Raat Parte (2024) para adultos | JWF™',
      'Regarder Gili Gili Raat Partie (2024) pour adultes | JWF™',
      'Gili Gili Raat Teil (2024) für Erwachsene ansehen | JWF™',
      '观看 Gili Gili Raat (2024) 成人内容 | JWF™',
      'Gili Gili Raat パート (2024) 大人向け | JWF™',
      'Gili Gili Raat 파트 (2024) 성인 전용 | JWF™',
      'Assistir Gili Gili Raat Parte (2024) para adultos | JWF™',
      'Guarda Gili Gili Raat Parte (2024) per adulti | JWF™',
      'Посмотреть Gili Gili Raat Часть (2024) для взрослых | JWF™',
      'مشاهدة Gili Gili Raat (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Gili Gili Raat (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedAdult = data.find(adult => adult.id === 'INDEX04')
  return {
    props: {
      adult: selectedAdult
    }

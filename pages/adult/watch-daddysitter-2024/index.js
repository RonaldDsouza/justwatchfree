...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/adult/watch-daddysitter-2024',
    name: 'Watch Adult Daddysitter (2024) | JWF™',
    alternateName: [
      'Ver Daddysitter Parte (2024) para adultos | JWF™',
      'Regarder Daddysitter Partie (2024) pour adultes | JWF™',
      'Daddysitter Teil (2024) für Erwachsene ansehen | JWF™',
      '观看 Daddysitter (2024) 成人内容 | JWF™',
      'Daddysitter パート (2024) 大人向け | JWF™',
      'Daddysitter 파트 (2024) 성인 전용 | JWF™',
      'Assistir Daddysitter Parte (2024) para adultos | JWF™',
      'Guarda Daddysitter Parte (2024) per adulti | JWF™',
      'Посмотреть Daddysitter Часть (2024) для взрослых | JWF™',
      'مشاهدة Daddysitter (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Daddysitter (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedAdult = data.find(adult => adult.id === 'INDEX17')
  return {
    props: {
      adult: selectedAdult
    }

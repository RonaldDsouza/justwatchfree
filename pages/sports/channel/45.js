...
const Ch01 = ({ sports }) => {
  ...
  return (
    <div>
      <Head>
        <title>Watch ESPN2 USA  | JWF™</title>
        ...
        <div className='flex flex-col text-blue-600 text-center items-center justify-center'>
          ...
          <div className={styles['iframe-container']}   style={{
            ...
            <iframe
              ...
              marginHeight='0'
              marginWidth='0'
              src='https://dlhd.sx/embed/stream-45.php'
              name='iframe_a'
              scrolling='no'
              allowFullScreen
              width='100%'
...
export async function getServerSideProps () {
  ...
  const selectedSports = data.find(sports => sports.id === 'INDEX45')
  return {
    props: {

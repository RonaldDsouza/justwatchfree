...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-csi-vegas-season-1-tv-series',
    name: 'Watch CSI: Vegas Season 1 (2024) | JWF™',
    alternateName: [
      'Ver CSI: Vegas Temporada 1 (2024) | JWF™',
      'Regarder CSI: Vegas Saison 1 (2024) | JWF™',
      'CSI: Vegas Staffel 1 (2024) ansehen | JWF™',
      '观看CSI：拉斯维加斯 第一季 (2024) | JWF™',
      'CSI: Vegas シーズン 1 (2024) を見る | JWF™',
      'CSI: Vegas 시즌 1 (2024) 보기 | JWF™',
      'Assistir CSI: Vegas Temporada 1 (2024) | JWF™',
      'Guarda CSI: Vegas Stagione 1 (2024) | JWF™',
      'Посмотреть CSI: Vegas Сезон 1 (2024) | JWF™',
      'مشاهدة CSI: Vegas الموسم 1 (2024) | JWF™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch CSI: Vegas Season 1 (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedTvshow = data.find(tvshow => tvshow.id === 'INDEX12')
  return {
    props: {

...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-john-wick-chapter-4-2023',
    name: 'Watch Movie John Wick Chapter 4 (2024) | JWF™',
    alternateName: [
      'Ver película John Wick Chapter 4 (2024) | JWF™',
      'Regarder le film John Wick Chapter 4 (2024) | JWF™',
      'Film John Wick Chapter 4 (2024) ansehen | JWF™',
      '观看电影 John Wick Chapter 4 (2024) | JWF™',
      '映画 John Wick Chapter 4 (2024) を見る | JWF™',
      '영화 John Wick Chapter 4 (2024) 보기 | JWF™',
      'Assistir Filme John Wick Chapter 4 (2024) | JWF™',
      'Guarda il film John Wick Chapter 4 (2024) | JWF™',
      'Посмотреть фильм John Wick Chapter 4 (2024) | JWF™',
      'مشاهدة فيلم John Wick Chapter 4 (2024) | جي دبليو إف™'
    ]
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie John Wick Chapter 4 (2024) | JWF™</title>

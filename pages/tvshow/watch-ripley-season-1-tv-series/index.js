...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-ripley-season-1-tv-series',
    name: 'Watch Ripley Season 1 (2024) | JWF™',
    alternateName: [
      'Ver Ripley Temporada 1 (2024) | JWF™',
      'Regarder Ripley Saison 1 (2024) | JWF™',
      'Ripley Staffel 1 (2024) ansehen | JWF™',
      '观看黑暗物质 第一季 (2024) | JWF™',
      'ダークマター シーズン 1 (2024) を見る | JWF™',
      '다크 매터 시즌 1 (2024) 보기 | JWF™',
      'Assistir Ripley Temporada 1 (2024) | JWF™',
      'Guarda Ripley Stagione 1 (2024) | JWF™',
      'Посмотреть Ripley Сезон 1 (2024) | JWF™',
      'مشاهدة Ripley الموسم 1 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Ripley Season 1 (2024) | JWF™</title>

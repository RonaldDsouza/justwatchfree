...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-in-a-violent-nature-2024',
    name: 'Watch Movie In a Violent Nature (2024) | JWF™',
    alternateName: [
      'Ver película In a Violent Nature (2024) | JWF™',
      'Regarder le film In a Violent Nature (2024) | JWF™',
      'Film In a Violent Nature (2024) ansehen | JWF™',
      '观看电影 In a Violent Nature (2024) | JWF™',
      '映画 In a Violent Nature (2024) を見る | JWF™',
      '영화 In a Violent Nature (2024) 보기 | JWF™',
      'Assistir Filme In a Violent Nature (2024) | JWF™',
      'Guarda il film In a Violent Nature (2024) | JWF™',
      'Посмотреть фильм In a Violent Nature (2024) | JWF™',
      'مشاهدة فيلم In a Violent Nature (2024) | جي دبليو إف™'
    ]
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie In a Violent Nature (2024) | JWF™</title>

...
const tvshowDetail = ({ tvshow }) => {
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      {
        text: 'Hotel Cocaine Season 1 - 2024',
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-hotel-cocaine-season-1-tv-series',
    name: 'Watch Hotel Cocaine Season 1 (2024) | JWF™',
    alternateName: [
      'Ver Hotel Cocaine Temporada 1 (2024) | JWF™',
      'Regarder Hotel Cocaine Saison 1 (2024) | JWF™',
      'Hotel Cocaine Staffel 1 (2024) ansehen | JWF™',
      '观看黑暗物质 第一季 (2024) | JWF™',
      'ダークマター シーズン 1 (2024) を見る | JWF™',
      '다크 매터 시즌 1 (2024) 보기 | JWF™',
      'Assistir Hotel Cocaine Temporada 1 (2024) | JWF™',
      'Guarda Hotel Cocaine Stagione 1 (2024) | JWF™',
      'Посмотреть Hotel Cocaine Сезон 1 (2024) | JWF™',
      'مشاهدة Hotel Cocaine الموسم 1 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Hotel Cocaine Season 1 (2024) | JWF™</title>

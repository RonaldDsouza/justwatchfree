...
const moviesDetail = ({ movie }) => {
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      {
        text: 'Bad Boys: Ride or Die - 2024',
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-bad-boys-ride-or-die-2024',
    name: 'Watch Movie Bad Boys: Ride or Die (2024) | JWF™',
    alternateName: [
      'Ver película Bad Boys: Ride or Die (2024) | JWF™',
      'Regarder le film Bad Boys: Ride or Die (2024) | JWF™',
      'Film Bad Boys: Ride or Die (2024) ansehen | JWF™',
      '观看电影 Bad Boys: Ride or Die (2024) | JWF™',
      '映画 Bad Boys: Ride or Die (2024) を見る | JWF™',
      '영화 Bad Boys: Ride or Die (2024) 보기 | JWF™',
      'Assistir Filme Bad Boys: Ride or Die (2024) | JWF™',
      'Guarda il film Bad Boys: Ride or Die (2024) | JWF™',
      'Посмотреть фильм Bad Boys: Ride or Die (2024) | JWF™',
      'مشاهدة فيلم Bad Boys: Ride or Die (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Bad Boys: Ride or Die (2024) | JWF™</title>

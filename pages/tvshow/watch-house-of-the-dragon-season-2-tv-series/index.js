...
const tvshowDetail = ({ tvshow }) => {
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      {
        text: 'House of the Dragon Season 2 - 2024',
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-house-of-the-dragon-season-2-tv-series',
    name: 'Watch House of the Dragon Season 2 (2024) | JWF™',
    alternateName: [
      'Ver House of the Dragon Temporada 2 (2024) | JWF™',
      'Regarder House of the Dragon Saison 2 (2024) | JWF™',
      'House of the Dragon Staffel 2 (2024) ansehen | JWF™',
      '观看 House of the Dragon 第一季 (2024) | JWF™',
      'ハウス・オブ・ザ・ドラゴン シーズン 2 (2024) を見る | JWF™',
      '하우스 오브 더 드래곤 시즌 2 (2024) 보기 | JWF™',
      'Assistir House of the Dragon Temporada 2 (2024) | JWF™',
      'Guarda House of the Dragon Stagione 2 (2024) | JWF™',
      'Посмотреть House of the Dragon Сезон 2 (2024) | JWF™',
      'مشاهدة House of the Dragon الموسم 2 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch House of the Dragon Season 2 (2024) | JWF™</title>

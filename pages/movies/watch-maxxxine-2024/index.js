...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-maxxxine-2024',
    name: 'Watch Movie MaXXXine (2024) | JWF™',
    alternateName: [
      'Ver película MaXXXine (2024) | JWF™',
      'Regarder le film MaXXXine (2024) | JWF™',
      'Film MaXXXine (2024) ansehen | JWF™',
      '观看电影 MaXXXine (2024) | JWF™',
      '映画 MaXXXine (2024) を見る | JWF™',
      '영화 MaXXXine (2024) 보기 | JWF™',
      'Assistir Filme MaXXXine (2024) | JWF™',
      'Guarda il film MaXXXine (2024) | JWF™',
      'Посмотреть фильм MaXXXine (2024) | JWF™',
      'مشاهدة فيلم MaXXXine (2024) | جي دبليو إف™'
    ]
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie MaXXXine (2024) | JWF™</title>

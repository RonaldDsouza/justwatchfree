...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-bloody-ishq-2024',
    name: 'Watch Movie Bloody Ishq (2024) | JWF™',
    alternateName: [
      'Ver película Bloody Ishq (2024) | JWF™',
      'Regarder le film Bloody Ishq (2024) | JWF™',
      'Film Bloody Ishq (2024) ansehen | JWF™',
      '观看电影 Bloody Ishq (2024) | JWF™',
      '映画 Bloody Ishq (2024) を見る | JWF™',
      '영화 Bloody Ishq (2024) 보기 | JWF™',
      'Assistir Filme Bloody Ishq (2024) | JWF™',
      'Guarda il film Bloody Ishq (2024) | JWF™',
      'Посмотреть фильм Bloody Ishq (2024) | JWF™',
      'مشاهدة فيلم Bloody Ishq (2024) | جي دبليو إف™'
    ]
   ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Bloody Ishq (2024) | JWF™</title>

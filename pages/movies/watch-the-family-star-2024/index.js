...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-the-family-star-2024',
    name: 'Watch Movie The Family Star (2024) | JWF™',
    alternateName: [
      'Ver película The Family Star (2024) | JWF™',
      'Regarder le film The Family Star (2024) | JWF™',
      'Film The Family Star (2024) ansehen | JWF™',
      '观看电影 The Family Star (2024) | JWF™',
      '映画 The Family Star (2024) を見る | JWF™',
      '영화 The Family Star (2024) 보기 | JWF™',
      'Assistir Filme The Family Star (2024) | JWF™',
      'Guarda il film The Family Star (2024) | JWF™',
      'Посмотреть фильм The Family Star (2024) | JWF™',
      'مشاهدة فيلم The Family Star (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie The Family Star (2024) | JWF™</title>

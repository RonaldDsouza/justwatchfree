...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://justwatchfree.vercel.app/tvshow/',
  headline: 'Watch Online Tvshow | JWF™',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Tvshow',
      item: 'https://justwatchfree.vercel.app/tvshow/'
    }
  ]
})
...
const tvshowPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Onile Tvshow | JWF™</title>
        ...
        <meta property='og:title' content=' Watch Online Tvshow | JWF™' />
      ...
      >
        Just Watch Free™ - TV Series Section.
      </h1>
      ...
      <h2
        ...
        >
          Popular TV Series  to Watch Search Now
         </h2>      

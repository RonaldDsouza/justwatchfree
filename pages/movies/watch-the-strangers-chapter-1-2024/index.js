...
const moviesDetail = ({ movie }) => {
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      {
        text: 'The Strangers: Chapter 1 - 2024',
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-the-strangers-chapter-1-2024',
    name: 'Watch Movie The Strangers: Chapter 1 (2024) | JWF™',
    alternateName: [
      'Ver película The Strangers: Chapter 1 (2024) | JWF™',
      'Regarder le film The Strangers: Chapter 1 (2024) | JWF™',
      'Film The Strangers: Chapter 1 (2024) ansehen | JWF™',
      '观看电影 The Strangers: Chapter 1 (2024) | JWF™',
      '映画 The Strangers: Chapter 1 (2024) を見る | JWF™',
      '영화 The Strangers: Chapter 1 (2024) 보기 | JWF™',
      'Assistir Filme The Strangers: Chapter 1 (2024) | JWF™',
      'Guarda il film The Strangers: Chapter 1 (2024) | JWF™',
      'Посмотреть фильм The Strangers: Chapter 1 (2024) | JWF™',
      'مشاهدة فيلم The Strangers: Chapter 1 (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie The Strangers: Chapter 1 (2024) | JWF™</title>

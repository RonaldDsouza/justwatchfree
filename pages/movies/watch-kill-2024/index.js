...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-kill-2024',
    name: 'Watch Movie Kill (2024) | JWF™',
    alternateName: [
      'Ver película Kill (2024) | JWF™',
      'Regarder le film Kill (2024) | JWF™',
      'Film Kill (2024) ansehen | JWF™',
      '观看电影 Kill (2024) | JWF™',
      '映画 Kill (2024) を見る | JWF™',
      '영화 Kill (2024) 보기 | JWF™',
      'Assistir Filme Kill (2024) | JWF™',
      'Guarda il film Kill (2024) | JWF™',
      'Посмотреть фильм Kill (2024) | JWF™',
      'مشاهدة فيلم Kill (2024) | جي دبليو إف™'
    ]
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Kill (2024) | JWF™</title>

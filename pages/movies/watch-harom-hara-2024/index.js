...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Harom Hara (2024) | JWF™',
    alternateName: [
      'Ver película Harom Hara (2024) | JWF™',
      'Regarder le film Harom Hara (2024) | JWF™',
      'Film Harom Hara (2024) ansehen | JWF™',
      '观看电影 Harom Hara (2024) | JWF™',
      '映画 Harom Hara (2024) を見る | JWF™',
      '영화 Harom Hara (2024) 보기 | JWF™',
      'Assistir Filme Harom Hara (2024) | JWF™',
      'Guarda il film Harom Hara (2024) | JWF™',
      'Посмотреть фильм Harom Hara (2024) | JWF™',
      'مشاهدة فيلم Harom Hara (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Harom Hara (2024) | JWF™</title>

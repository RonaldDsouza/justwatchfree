...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-a-family-affair-2024',
    name: 'Watch Movie A Family Affair (2024) | JWF™',
    alternateName: [
      'Ver película Un asunto de familia (2024) | JWF™',
      'Regarder le film Une affaire de famille (2024) | JWF™',
      'Film 36 Tage (2024) ansehen | JWF™',
      '观看电影 36 天 (2024) | JWF™',
      '映画36日間 (2024) を見る | JWF™',
      '영화 36일 (2024) 보기 | JWF™',
      'Assistir Filme 36 Dias (2024) | JWF™',
      'Guarda il film 36 giorni (2024) | JWF™',
      'Посмотреть фильм 36 дней (2024) | JWF™',
      'مشاهدة فيلم A Family Affair (2024) | جي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie A Family Affair (2024) | JWF™</title>

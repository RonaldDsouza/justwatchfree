...
const AdultPage = ({ adults }) => {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      {
        '@type': 'WebSite',
        '@id': 'https://justwatchfree.vercel.app/adult/#website',
      ...
      {
        '@type': 'WebPage',
        '@id': 'https://justwatchfree.vercel.app/adult/#webpage',
        url: 'https://justwatchfree.vercel.app/adult',
        name: 'Movie',
  ...
  const languagesSchema = JSON.stringify({
    ...
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/adult',
    name: 'Just Watch Free™ - Adult Content',
    alternateName: [
      'Just Watch Free™ - Contenido para adultos',
      'Just Watch Free™ - Contenu pour adultes',
      'Just Watch Free™ - Erwachsene Inhalte',
      'Just Watch Free™ - 成人内容',
      'Just Watch Free™ - アダルトコンテンツ',
      'Just Watch Free™ - 성인 콘텐츠',
      'Just Watch Free™ - Conteúdo adulto',
      'Just Watch Free™ - Contenuto per adulti',
      'Just Watch Free™ - Контент для взрослых',
      'Just Watch Free™ - محتوى للبالغين'
    ],
    inLanguage: [
  ...
  return (
    <div className={styles.container}>
        ...
        >
          Just Watch Free™ - Adult Content Section.
        </h1>

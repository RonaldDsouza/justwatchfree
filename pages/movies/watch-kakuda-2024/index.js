...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-kakuda-2024',
    name: 'Watch Movie Kakuda (2024) | JWF™',
    alternateName: [
      'Ver película Kakuda (2024) | JWF™',
      'Regarder le film Kakuda (2024) | JWF™',
      'Film Kakuda (2024) ansehen | JWF™',
      '观看电影 Kakuda (2024) | JWF™',
      '映画 Kakuda (2024) を見る | JWF™',
      '영화 Kakuda (2024) 보기 | JWF™',
      'Assistir Filme Kakuda (2024) | JWF™',
      'Guarda il film Kakuda (2024) | JWF™',
      'Посмотреть фильм Kakuda (2024) | JWF™',
      'مشاهدة فيلم Kakuda (2024) | جي دبليو إف™'
    ]
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Kakuda (2024) | JWF™</title>

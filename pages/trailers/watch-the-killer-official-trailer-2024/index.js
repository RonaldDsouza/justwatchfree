...
const trailersDetail = ({ trailers }) => {
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      {
        text: 'The Killer - 2024',
        url: 'https://www.imdb.com/title/tt1121948/'
      }
    ]
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch The Killer Official Trailer | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedTrailers = data.find(trailers => trailers.id === 'INDEX06')
  return {
    props: {

...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Adult Call Me Part 01 (2024) | JWF™',
    alternateName: [
      'Ver Call Me Parte 01 (2024) para adultos | JWF™',
      'Regarder Call Me Partie 01 (2024) pour adultes | JWF™',
      'Call Me Teil 01 (2024) für Erwachsene ansehen | JWF™',
      '观看 Call Me 第01部分 (2024) 成人内容 | JWF™',
      'Call Me パート01 (2024) 大人向け | JWF™',
      'Call Me 파트 01 (2024) 성인 전용 | JWF™',
      'Assistir Call Me Parte 01 (2024) para adultos | JWF™',
      'Guarda Call Me Parte 01 (2024) per adulti | JWF™',
      'Посмотреть Call Me Часть 01 (2024) для взрослых | JWF™',
      'مشاهدة Call Me الجزء 01 (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Call Me Part 01 (2024) | JWF™</title>

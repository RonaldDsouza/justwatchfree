...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-savi-2024',
    name: 'Watch Movie Savi (2024) | JWF™',
    alternateName: [
      'Ver película Savi (2024) | JWF™',
      'Regarder le film Savi (2024) | JWF™',
      'Film Savi (2024) ansehen | JWF™',
      '观看电影 Savi (2024) | JWF™',
      '映画 Savi (2024) を見る | JWF™',
      '영화 Savi (2024) 보기 | JWF™',
      'Assistir Filme Savi (2024) | JWF™',
      'Guarda il film Savi (2024) | JWF™',
      'Посмотреть фильм Savi (2024) | JWF™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Savi (2024) | JWF™</title>

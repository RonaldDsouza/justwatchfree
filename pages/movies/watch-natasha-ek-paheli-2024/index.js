...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-natasha-ek-paheli-2024',
    name: 'Watch Movie Natasha Ek Paheli (2024) | JWF™',
    alternateName: [
      'Ver película Natasha Ek Paheli (2024) | JWF™',
      'Regarder le film Natasha Ek Paheli (2024) | JWF™',
      'Film Natasha Ek Paheli (2024) ansehen | JWF™',
      '观看电影 Natasha Ek Paheli (2024) | JWF™',
      '映画 Natasha Ek Paheli (2024) を見る | JWF™',
      '영화 Natasha Ek Paheli (2024) 보기 | JWF™',
      'Assistir Filme Natasha Ek Paheli (2024) | JWF™',
      'Guarda il film Natasha Ek Paheli (2024) | JWF™',
      'Посмотреть фильм Natasha Ek Paheli (2024) | JWF™',
      'مشاهدة فيلم Natasha Ek Paheli (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Natasha Ek Paheli (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(movie => movie.id === 'INDEX32')
  return {
    props: {
      movie: selectedMovie
    }

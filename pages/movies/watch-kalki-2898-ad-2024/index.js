...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-kalki-2898-ad-2024',
    name: 'Watch Movie Kalki 2898 AD (2024) | JWF™',
    alternateName: [
      'Ver película Kalki 2898 AD (2024) | JWF™',
      'Regarder le film Kalki 2898 AD (2024) | JWF™',
      'Film Kalki 2898 AD (2024) ansehen | JWF™',
      '观看电影 Kalki 2898 AD (2024) | JWF™',
      '映画 Kalki 2898 AD (2024) を見る | JWF™',
      '영화 Kalki 2898 AD (2024) 보기 | JWF™',
      'Assistir Filme Kalki 2898 AD (2024) | JWF™',
      'Guarda il film Kalki 2898 AD (2024) | JWF™',
      'Посмотреть фильм Kalki 2898 AD (2024) | JWF™',
      'مشاهدة فيلم Kalki 2898 AD (2024) | جي دبليو إف™'
    ]
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Kalki 2898 AD (2024) | JWF™</title>

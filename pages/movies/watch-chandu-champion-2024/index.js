...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-chandu-champion-2024',
    name: 'Watch Movie Chandu Champion (2024) | JWF™',
    alternateName: [
      'Ver película Chandu Champion (2024) | JWF™',
      'Regarder le film Chandu Champion (2024) | JWF™',
      'Film Chandu Champion (2024) ansehen | JWF™',
      '观看电影 Chandu Champion (2024) | JWF™',
      '映画 Chandu Champion (2024) を見る | JWF™',
      '영화 Chandu Champion (2024) 보기 | JWF™',
      'Assistir Filme Chandu Champion (2024) | JWF™',
      'Guarda il film Chandu Champion (2024) | JWF™',
      'Посмотреть фильм Chandu Champion (2024) | JWF™',
      'مشاهدة فيلم Chandu Champion (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Chandu Champion (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(movie => movie.id === 'INDEX41')
  return {
    props: {
      movie: selectedMovie
    }

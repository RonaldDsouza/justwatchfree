...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-kaagaz-2-2024',
    name: 'Watch Movie Kaagaz 2 (2024) | JWF™',
    alternateName: [
      'Ver película Kaagaz 2 (2024) | JWF™',
      'Regarder le film Kaagaz 2 (2024) | JWF™',
      'Film Kaagaz 2 (2024) ansehen | JWF™',
      '观看电影 Kaagaz 2 (2024) | JWF™',
      '映画 Kaagaz 2 (2024) を見る | JWF™',
      '영화 Kaagaz 2 (2024) 보기 | JWF™',
      'Assistir Filme Kaagaz 2 (2024) | JWF™',
      'Guarda il film Kaagaz 2 (2024) | JWF™',
      'Посмотреть фильм Kaagaz 2 (2024) | JWF™',
      'مشاهدة فيلم Kaagaz 2 (2024) | جي دبليو إف™'
    ]
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Kaagaz 2 (2024) | JWF™</title>

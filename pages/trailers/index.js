...
const TrailerPage = ({ trailers }) => {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      {
        '@type': 'WebSite',
        '@id': 'https://justwatchfree.vercel.app/trailers/#website',
      ...
      {
        '@type': 'WebPage',
        '@id': 'https://justwatchfree.vercel.app/trailers/#webpage',
        url: 'https://justwatchfree.vercel.app/trailers',
        name: 'Movie',
  ...
  return (
    <div className={styles.container}>
        ...
        >
          Just Watch Free™ - Trailer Section.
        </h1>

...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/adult/watch-devil-part-1-2024',
    name: 'Watch Adult Devil Part 01 (2024) | JWF™',
    alternateName: [
      'Ver Devil Parte 01 (2024) para adultos | JWF™',
      'Regarder Devil Partie 01 (2024) pour adultes | JWF™',
      'Devil Teil 01 (2024) für Erwachsene ansehen | JWF™',
      '观看 Devil 第01部分 (2024) 成人内容 | JWF™',
      'Devil パート01 (2024) 大人向け | JWF™',
      'Devil 파트 01 (2024) 성인 전용 | JWF™',
      'Assistir Devil Parte 01 (2024) para adultos | JWF™',
      'Guarda Devil Parte 01 (2024) per adulti | JWF™',
      'Посмотреть Devil Часть 01 (2024) для взрослых | JWF™',
      'مشاهدة Devil الجزء 01 (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Devil Part 1 (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedAdult = data.find(adult => adult.id === 'INDEX06')
  return {
    props: {
      adult: selectedAdult
    }

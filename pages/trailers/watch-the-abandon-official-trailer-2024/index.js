    ...
    const linkTargets = [
      {
        ...
        url: 'https://www.imdb.com/title/tt10273738/'
      }
    ]
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch The Abandon Official Trailer | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedTrailers = data.find(trailers => trailers.id === 'INDEX09')
  return {
    props: {

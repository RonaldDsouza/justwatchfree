...
const tvshowDetail = ({ tvshow }) => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch('https://justwatchfree.vercel.app/tvshow.json')
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      {
        text: 'Heeramandi: The Diamond Bazaar Season 1 - 2024',
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-heeramandi-the-diamond-bazaar-season-1-tv-series',
    name: 'Watch Heeramandi: The Diamond Bazaar Season 1 (2024) | JWF™',
    alternateName: [
      'Ver Heeramandi: The Diamond Bazaar Temporada 1 (2024) | JWF™',
      'Regarder Heeramandi: The Diamond Bazaar Saison 1 (2024) | JWF™',
      'Heeramandi: The Diamond Bazaar Staffel 1 (2024) ansehen | JWF™',
      '观看黑暗物质 第一季 (2024) | JWF™',
      'ダークマター シーズン 1 (2024) を見る | JWF™',
      '다크 매터 시즌 1 (2024) 보기 | JWF™',
      'Assistir Heeramandi: The Diamond Bazaar Temporada 1 (2024) | JWF™',
      'Guarda Heeramandi: The Diamond Bazaar Stagione 1 (2024) | JWF™',
      'Посмотреть Heeramandi: The Diamond Bazaar Сезон 1 (2024) | JWF™',
      'مشاهدة Heeramandi: The Diamond Bazaar الموسم 1 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Heeramandi: The Diamond Bazaar Season 1 (2024) | JWF™</title>
...
export async function getServerSideProps () {
  const res = await fetch('https://justwatchfree.vercel.app/tvshow.json')

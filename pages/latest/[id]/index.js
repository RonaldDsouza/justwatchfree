...
const latestDetail = ({ latest }) => {
  ...
  const enhancedParagraph = (text) => {
    const linkTargets = [
      { text: 'Watch Online Wild Wild Punjab', url: 'https://justwatchfree.vercel.app/movies/watch-wild-wild-punjab-2024' },
      { text: 'Watch The Killer Trailer', url: 'https://justwatchfree.vercel.app/trailers/watch-the-killer-official-trailer-2024' },
      { text: 'JWM Trailers', url: 'https://justwatchfree.vercel.app/trailers/' },
      { text: 'JWM Movies', url: 'https://justwatchfree.vercel.app/movies/' },
      { text: 'JWM TV Series s', url: 'https://justwatchfree.vercel.app/yvshow/' },
      { text: 'JWM Adult Content', url: 'https://justwatchfree.vercel.app/adult/' },
  ...
  const uwatchfreeSchema = JSON.stringify([
    {
      ...
      image: [
        'https://justwatchfree.vercel.app/favicon.ico'
      ],
      logo: {
        '@type': 'ImageObject',
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: 'Dr Trailer',
        url: 'https://justwatchfree.vercel.appauthor/justwatchfree/',
        image: {
          '@type': 'ImageObject',
      ...
      },
      {
        ...
        headline: ` ${latest.name} | JWF™`,
        datePublished: '2024-01-13T13:00:00+00:00',
        dateModified: '2024-01-13T13:13:00+00:00',
        articleSection: 'latest',
        author: {
          '@id': 'https://justwatchfree.vercel.appauthor/justwatchfree/'
        },
        publisher: {
          '@id': 'https://gravatar.com/drtrailer2022/#person'
        },
        description: `Just Watch Free™ - Explore. Discover. Online. Stream online HD movies with Google Translate for access in any language, worldwide.`,
        image: latest.image,
        name: ` ${latest.name} | JWF™`,
        isPartOf: {
          '@id': `/${latest['latest.watch']}#webpage`
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> {latest && latest.name} | JWF™</title>
        ...
        <meta
          property='og:title'
          content={`${latest && latest.name} - JWF™`}
        />

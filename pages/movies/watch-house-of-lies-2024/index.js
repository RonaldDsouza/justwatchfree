...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-house-of-lies-2024',
    name: 'Watch Movie House Of Lies (2024) | JWF™',
    alternateName: [
      'Ver película House Of Lies (2024) | JWF™',
      'Regarder le film House Of Lies (2024) | JWF™',
      'Film House Of Lies (2024) ansehen | JWF™',
      '观看电影 House Of Lies (2024) | JWF™',
      '映画 House Of Lies (2024) を見る | JWF™',
      '영화 House Of Lies (2024) 보기 | JWF™',
      'Assistir Filme House Of Lies (2024) | JWF™',
      'Guarda il film House Of Lies (2024) | JWF™',
      'Посмотреть фильм House Of Lies (2024) | JWF™',
      'مشاهدة فيلم House Of Lies (2024) | جي دبليو إف™'
    ]
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie House Of Lies (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(movie => movie.id === 'INDEX35')
  return {
    props: {
      movie: selectedMovie
    }

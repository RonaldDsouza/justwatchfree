...
const moviesDetail = ({ movie }) => {
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      {
        text: 'My Spy the Eternal City - 2024',
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-my-spy-the-eternal-city-2024',
    name: 'Watch Movie My Spy the Eternal City (2024) | JWF™',
    alternateName: [
      'Ver película My Spy the Eternal City (2024) | JWF™',
      'Regarder le film My Spy the Eternal City (2024) | JWF™',
      'Film My Spy the Eternal City (2024) ansehen | JWF™',
      '观看电影 My Spy the Eternal City (2024) | JWF™',
      '映画 My Spy the Eternal City (2024) を見る | JWF™',
      '영화 My Spy the Eternal City (2024) 보기 | JWF™',
      'Assistir Filme My Spy the Eternal City (2024) | JWF™',
      'Guarda il film My Spy the Eternal City (2024) | JWF™',
      'Посмотреть фильм My Spy the Eternal City (2024) | JWF™',
      'مشاهدة فيلم My Spy the Eternal City (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie My Spy the Eternal City (2024) | JWF™</title>

...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-dead-sea-2024',
    name: 'Watch Movie Dead Sea (2024) | JWF™',
    alternateName: [
      'Ver película Dead Sea (2024) | JWF™',
      'Regarder le film Dead Sea (2024) | JWF™',
      'Film Dead Sea (2024) ansehen | JWF™',
      '观看电影 Dead Sea (2024) | JWF™',
      '映画 Dead Sea (2024) を見る | JWF™',
      '영화 Dead Sea (2024) 보기 | JWF™',
      'Assistir Filme Dead Sea (2024) | JWF™',
      'Guarda il film Dead Sea (2024) | JWF™',
      'Посмотреть фильм Dead Sea (2024) | JWF™',
      'مشاهدة فيلم Dead Sea (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Dead Sea (2024) | JWF™</title>

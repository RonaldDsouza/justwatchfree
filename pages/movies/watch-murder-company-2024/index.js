...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-murder-company-2024',
    name: 'Watch Movie Murder Company (2024) | JWF™',
    alternateName: [
      'Ver película Murder Company (2024) | JWF™',
      'Regarder le film Murder Company (2024) | JWF™',
      'Film Murder Company (2024) ansehen | JWF™',
      '观看电影 Murder Company (2024) | JWF™',
      '映画 Murder Company (2024) を見る | JWF™',
      '영화 Murder Company (2024) 보기 | JWF™',
      'Assistir Filme Murder Company (2024) | JWF™',
      'Guarda il film Murder Company (2024) | JWF™',
      'Посмотреть фильм Murder Company (2024) | JWF™',
      'مشاهدة فيلم Murder Company (2024) | جي دبليو إف™'
    ]
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Murder Company (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(movie => movie.id === 'INDEX22A')
  return {
    props: {
      movie: selectedMovie
    }

...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-saindhav-2024',
    name: 'Watch Movie Saindhav (2024) | JWF™',
    alternateName: [
      'Ver película Saindhav (2024) | JWF™',
      'Regarder le film Saindhav (2024) | JWF™',
      'Film Saindhav (2024) ansehen | JWF™',
      '观看电影 Saindhav (2024) | JWF™',
      '映画 Saindhav (2024) を見る | JWF™',
      '영화 Saindhav (2024) 보기 | JWF™',
      'Assistir Filme Saindhav (2024) | JWF™',
      'Guarda il film Saindhav (2024) | JWF™',
      'Посмотреть фильм Saindhav (2024) | JWF™',
      'مشاهدة فيلم Saindhav (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Saindhav (2024) | JWF™</title>

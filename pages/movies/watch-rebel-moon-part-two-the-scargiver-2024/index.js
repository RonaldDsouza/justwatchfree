...
const moviesDetail = ({ movie }) => {
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      {
        text: 'Rebel Moon - Part Two: The Scargiver - 2024',
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-rebel-moon-part-two-the-scargiver-2024',
    name: 'Watch Movie Rebel Moon - Part Two: The Scargiver (2024) | JWF™',
    alternateName: [
      'Ver película Rebel Moon - Part Two: The Scargiver (2024) | JWF™',
      'Regarder le film Rebel Moon - Part Two: The Scargiver (2024) | JWF™',
      'Film Rebel Moon - Part Two: The Scargiver (2024) ansehen | JWF™',
      '观看电影 Rebel Moon - Part Two: The Scargiver (2024) | JWF™',
      '映画 Rebel Moon - Part Two: The Scargiver (2024) を見る | JWF™',
      '영화 Rebel Moon - Part Two: The Scargiver (2024) 보기 | JWF™',
      'Assistir Filme Rebel Moon - Part Two: The Scargiver (2024) | JWF™',
      'Guarda il film Rebel Moon - Part Two: The Scargiver (2024) | JWF™',
      'Посмотреть фильм Rebel Moon - Part Two: The Scargiver (2024) | JWF™',
      'مشاهدة فيلم Rebel Moon - Part Two: The Scargiver (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Rebel Moon - Part Two: The Scargiver (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(movie => movie.id === 'INDEX55')
  return {
    props: {
      movie: selectedMovie
    }

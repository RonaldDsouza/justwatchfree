...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/adult/watch-kaulayaw-2024',
    name: 'Watch Adult Kaulayaw (2024) | JWF™',
    alternateName: [
      'Ver Kaulayaw Parte (2024) para adultos | JWF™',
      'Regarder Kaulayaw Partie (2024) pour adultes | JWF™',
      'Kaulayaw Teil (2024) für Erwachsene ansehen | JWF™',
      '观看 Kaulayaw (2024) 成人内容 | JWF™',
      'Kaulayaw パート (2024) 大人向け | JWF™',
      'Kaulayaw 파트 (2024) 성인 전용 | JWF™',
      'Assistir Kaulayaw Parte (2024) para adultos | JWF™',
      'Guarda Kaulayaw Parte (2024) per adulti | JWF™',
      'Посмотреть Kaulayaw Часть (2024) для взрослых | JWF™',
      'مشاهدة Kaulayaw (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Kaulayaw (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedAdult = data.find(adult => adult.id === 'INDEX09')
  return {
    props: {
      adult: selectedAdult
    }

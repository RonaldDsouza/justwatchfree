...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-Maharani-season-1-tv-series',
    name: 'Watch Maharani Season 1 (2020) | JWF™',
    alternateName: [
      'Ver Maharani Temporada 1 (2024) | JWF™',
      'Regarder Maharani Saison 1 (2024) | JWF™',
      'Maharani Staffel 1 (2024) ansehen | JWF™',
      '观看黑暗物质 第一季 (2024) | JWF™',
      'ダークマター シーズン 1 (2024) を見る | JWF™',
      '다크 매터 시즌 1 (2024) 보기 | JWF™',
      'Assistir Maharani Temporada 1 (2024) | JWF™',
      'Guarda Maharani Stagione 1 (2024) | JWF™',
      'Посмотреть Maharani Сезон 1 (2024) | JWF™',
      'مشاهدة Maharani الموسم 1 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Maharani Season 1 (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedTvshow = data.find(tvshow => tvshow.id === 'INDEX28')
  return {
    props: {

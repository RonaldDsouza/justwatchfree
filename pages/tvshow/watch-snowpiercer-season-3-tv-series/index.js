...
const tvshowDetail = ({ tvshow }) => {
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      {
        text: 'Snowpiercer Season 3 - 2024',
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-snowpiercer-season-3-tv-series',
    name: 'Watch Snowpiercer Season 3 (2024) | JWF™',
    alternateName: [
      'Ver Snowpiercer Temporada 3 (2024) | JWF™',
      'Regarder Snowpiercer Saison 3 (2024) | JWF™',
      'Snowpiercer Staffel 3 (2024) ansehen | JWF™',
      '观看 Snowpiercer 第三季 (2024) | JWF™',
      'ミルザプール シーズン 3 (2024) を見る | JWF™',
      '미르자푸르 시즌 3 (2024) 보기 | JWF™',
      'Assistir Snowpiercer Temporada 3 (2024) | JWF™',
      'Guarda Snowpiercer Stagione 3 (2024) | JWF™',
      'Посмотреть Snowpiercer Сезон 3 (2024) | JWF™',
      'مشاهدة Snowpiercer الموسم 3 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Snowpiercer Season 3 (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedTvshow = data.find(tvshow => tvshow.id === 'INDEX23')
  return {
    props: {

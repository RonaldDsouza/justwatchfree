...
const tvshowDetail = ({ tvshow }) => {
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      {
        text: 'Time Bandits Season 1 - 2024',
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-time-bandits-season-1-tv-series',
    name: 'Watch Time Bandits Season 1 (2024) | JWF™',
    alternateName: [
      'Ver Time Bandits Temporada 1 (2024) | JWF™',
      'Regarder Time Bandits Saison 1 (2024) | JWF™',
      'Time Bandits Staffel 1 (2024) ansehen | JWF™',
      '观看黑暗物质 第一季 (2024) | JWF™',
      'ダークマター シーズン 1 (2024) を見る | JWF™',
      '다크 매터 시즌 1 (2024) 보기 | JWF™',
      'Assistir Time Bandits Temporada 1 (2024) | JWF™',
      'Guarda Time Bandits Stagione 1 (2024) | JWF™',
      'Посмотреть Time Bandits Сезон 1 (2024) | JWF™',
      'مشاهدة Time Bandits الموسم 1 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Time Bandits Season 1 (2024) | JWF™</title>

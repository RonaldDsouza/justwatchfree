...
const trailersDetail = ({ trailers }) => {
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      {
        text: 'The Day of the Jackal - 2024',
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch The Day of the Jackal Official Trailer | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedTrailers = data.find(trailers => trailers.id === 'INDEX08')
  return {
    props: {

...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-detained-2024',
    name: 'Watch Movie Detained (2024) | JWF™',
    alternateName: [
      'Ver película Detained (2024) | JWF™',
      'Regarder le film Detained (2024) | JWF™',
      'Film Detained (2024) ansehen | JWF™',
      '观看电影 Detained (2024) | JWF™',
      '映画 Detained (2024) を見る | JWF™',
      '영화 Detained (2024) 보기 | JWF™',
      'Assistir Filme Detained (2024) | JWF™',
      'Guarda il film Detained (2024) | JWF™',
      'Посмотреть фильм Detained (2024) | JWF™',
      'مشاهدة فيلم Detained (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Detained (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(movie => movie.id === 'INDEX52')
  return {
    props: {
      movie: selectedMovie
    }

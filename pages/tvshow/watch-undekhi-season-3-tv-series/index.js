...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-undekhi-season-3-tv-series',
    name: 'Watch Undekhi Season 3 (2024) | JWF™',
    alternateName: [
      'Ver Undekhi Temporada 3 (2024) | JWF™',
      'Regarder Undekhi Saison 3 (2024) | JWF™',
      'Undekhi Staffel 3 (2024) ansehen | JWF™',
      '观看 Undekhi 第三季 (2024) | JWF™',
      'ミルザプール シーズン 3 (2024) を見る | JWF™',
      '미르자푸르 시즌 3 (2024) 보기 | JWF™',
      'Assistir Undekhi Temporada 3 (2024) | JWF™',
      'Guarda Undekhi Stagione 3 (2024) | JWF™',
      'Посмотреть Undekhi Сезон 3 (2024) | JWF™',
      'مشاهدة Undekhi الموسم 3 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Undekhi Season 3 (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedTvshow = data.find(tvshow => tvshow.id === 'INDEX04')
  return {
    props: {

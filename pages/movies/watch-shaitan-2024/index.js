...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-shaitan-2024',
    name: 'Watch Movie Shaitan (2024) | JWF™',
    alternateName: [
      'Ver película Shaitan (2024) | JWF™',
      'Regarder le film Shaitan (2024) | JWF™',
      'Film Shaitan (2024) ansehen | JWF™',
      '观看电影 Shaitan (2024) | JWF™',
      '映画 Shaitan (2024) を見る | JWF™',
      '영화 Shaitan (2024) 보기 | JWF™',
      'Assistir Filme Shaitan (2024) | JWF™',
      'Guarda il film Shaitan (2024) | JWF™',
      'Посмотреть фильм Shaitan (2024) | JWF™',
      'مشاهدة فيلم Shaitan (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Shaitan (2024) | JWF™</title>

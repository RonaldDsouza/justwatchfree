    ...
    const linkTargets = [
      {
        ...
        url: 'https://www.imdb.com/title/tt17371078/'
      }
    ]
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch The Ark Season 2 Official Trailer | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedTrailers = data.find(trailers => trailers.id === 'INDEX07')
  return {
    props: {

...
const Ch01 = ({ sports }) => {
  ...
  return (
    <div>
      <Head>
        <title>Watch Sport TV2 Portugal | JWF™</title>
      ...
      {/* <div className='bg-gray-600 shadow'> */}
        <h1 className='py-5 font-bold leading-none tracking-tight text-green-500 text-center text-3xl dark:text-white'>
          Watch Live Stream Sport TV2 Portugal
        </h1>
        <div className='flex flex-col text-blue-600 text-center items-center justify-center'>
          ...
          <div className={styles['iframe-container']}   style={{
            ...
            <iframe
              ...
              marginHeight='0'
              marginWidth='0'
              src='https://dlhd.sx/embed/stream-74.php'
              name='iframe_a'
              scrolling='no'
              allowFullScreen
              width='100%'
...
export async function getServerSideProps () {
  ...
  const selectedSports = data.find(sports => sports.id === 'INDEX74')
  return {
    props: {

...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-trigger-warning-2024',
    name: 'Watch Movie Trigger Warning (2024) | JWF™',
    alternateName: [
      'Ver película Trigger Warning (2024) | JWF™',
      'Regarder le film Trigger Warning (2024) | JWF™',
      'Film Trigger Warning (2024) ansehen | JWF™',
      '观看电影 Trigger Warning (2024) | JWF™',
      '映画 Trigger Warning (2024) を見る | JWF™',
      '영화 Trigger Warning (2024) 보기 | JWF™',
      'Assistir Filme Trigger Warning (2024) | JWF™',
      'Guarda il film Trigger Warning (2024) | JWF™',
      'Посмотреть фильм Trigger Warning (2024) | JWF™',
      'مشاهدة فيلم Trigger Warning (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Trigger Warning (2024) | JWF™</title>

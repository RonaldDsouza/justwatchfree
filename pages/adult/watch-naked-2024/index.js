...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/adult/watch-naked-2024',
    name: 'Watch Adult Naked (2024) | JWF™',
    alternateName: [
      'Ver Naked Parte (2024) para adultos | JWF™',
      'Regarder Naked Partie (2024) pour adultes | JWF™',
      'Naked Teil (2024) für Erwachsene ansehen | JWF™',
      '观看 Naked (2024) 成人内容 | JWF™',
      'Naked パート (2024) 大人向け | JWF™',
      'Naked 파트 (2024) 성인 전용 | JWF™',
      'Assistir Naked Parte (2024) para adultos | JWF™',
      'Guarda Naked Parte (2024) per adulti | JWF™',
      'Посмотреть Naked Часть (2024) для взрослых | JWF™',
      'مشاهدة Naked (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Naked (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedAdult = data.find(adult => adult.id === 'INDEX03')
  return {
    props: {
      adult: selectedAdult
    }

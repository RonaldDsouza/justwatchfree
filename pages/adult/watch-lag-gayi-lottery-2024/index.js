...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/adult/watch-lag-gayi-lottery-2024',
    name: 'Watch Adult Lag Gayi Lottery (2024) | JWF™',
    alternateName: [
      'Ver Lag Gayi Lottery Parte (2024) para adultos | JWF™',
      'Regarder Lag Gayi Lottery Partie (2024) pour adultes | JWF™',
      'Lag Gayi Lottery Teil (2024) für Erwachsene ansehen | JWF™',
      '观看 Lag Gayi Lottery (2024) 成人内容 | JWF™',
      'Lag Gayi Lottery パート (2024) 大人向け | JWF™',
      'Lag Gayi Lottery 파트 (2024) 성인 전용 | JWF™',
      'Assistir Lag Gayi Lottery Parte (2024) para adultos | JWF™',
      'Guarda Lag Gayi Lottery Parte (2024) per adulti | JWF™',
      'Посмотреть Lag Gayi Lottery Часть (2024) для взрослых | JWF™',
      'مشاهدة Lag Gayi Lottery (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Lag Gayi Lottery (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedAdult = data.find(adult => adult.id === 'INDEX12')
  return {
    props: {
      adult: selectedAdult
    }

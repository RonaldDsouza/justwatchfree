...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-upload-season-2-tv-series',
    name: 'Watch Upload Season 2 (2024) | JWF™',
    alternateName: [
      'Ver Upload Temporada 2 (2024) | JWF™',
      'Regarder Upload Saison 2 (2024) | JWF™',
      'Upload Staffel 2 (2024) ansehen | JWF™',
      '观看黑暗物质 第一季 (2024) | JWF™',
      'ダークマター シーズン 2 (2024) を見る | JWF™',
      '다크 매터 시즌 2 (2024) 보기 | JWF™',
      'Assistir Upload Temporada 2 (2024) | JWF™',
      'Guarda Upload Stagione 2 (2024) | JWF™',
      'Посмотреть Upload Сезон 2 (2024) | JWF™',
      'مشاهدة Upload الموسم 2 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Upload Season 2 (2020) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedTvshow = data.find(tvshow => tvshow.id === 'INDEX26')
  return {
    props: {

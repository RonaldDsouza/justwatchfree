...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-red-eye-season-1-tv-series',
    name: 'Watch Red Eye Season 1 (2024) | JWF™',
    alternateName: [
      'Ver Red Eye Temporada 1 (2024) | JWF™',
      'Regarder Red Eye Saison 1 (2024) | JWF™',
      'Red Eye Staffel 1 (2024) ansehen | JWF™',
      '观看黑暗物质 第一季 (2024) | JWF™',
      'ダークマター シーズン 1 (2024) を見る | JWF™',
      '다크 매터 시즌 1 (2024) 보기 | JWF™',
      'Assistir Red Eye Temporada 1 (2024) | JWF™',
      'Guarda Red Eye Stagione 1 (2024) | JWF™',
      'Посмотреть Red Eye Сезон 1 (2024) | JWF™',
      'مشاهدة Red Eye الموسم 1 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Red Eye Season 1 (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedTvshow = data.find(tvshow => tvshow.id === 'INDEX06')
  return {
    props: {

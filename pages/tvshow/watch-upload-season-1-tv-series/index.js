...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-upload-season-1-tv-series',
    name: 'Watch Upload Season 1 (2024) | JWF™',
    alternateName: [
      'Ver Upload Temporada 1 (2024) | JWF™',
      'Regarder Upload Saison 1 (2024) | JWF™',
      'Upload Staffel 1 (2024) ansehen | JWF™',
      '观看黑暗物质 第一季 (2024) | JWF™',
      'ダークマター シーズン 1 (2024) を見る | JWF™',
      '다크 매터 시즌 1 (2024) 보기 | JWF™',
      'Assistir Upload Temporada 1 (2024) | JWF™',
      'Guarda Upload Stagione 1 (2024) | JWF™',
      'Посмотреть Upload Сезон 1 (2024) | JWF™',
      'مشاهدة Upload الموسم 1 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Upload Season 1 (2020) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedTvshow = data.find(tvshow => tvshow.id === 'INDEX25')
  return {
    props: {

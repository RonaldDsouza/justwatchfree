...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-love-me-if-you-dare-2024',
    name: 'Watch Movie Love Me If You Dare (2024) | JWF™',
    alternateName: [
      'Ver película Love Me If You Dare (2024) | JWF™',
      'Regarder le film Love Me If You Dare (2024) | JWF™',
      'Film Love Me If You Dare (2024) ansehen | JWF™',
      '观看电影 Love Me If You Dare (2024) | JWF™',
      '映画 Love Me If You Dare (2024) を見る | JWF™',
      '영화 Love Me If You Dare (2024) 보기 | JWF™',
      'Assistir Filme Love Me If You Dare (2024) | JWF™',
      'Guarda il film Love Me If You Dare (2024) | JWF™',
      'Посмотреть фильм Love Me If You Dare (2024) | JWF™',
      'مشاهدة فيلم Love Me If You Dare (2024) | جي دبليو إف™'
    ]
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Love Me If You Dare (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(movie => movie.id === 'INDEX58')
  return {
    props: {
      movie: selectedMovie
    }

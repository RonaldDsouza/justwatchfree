...
const moviesDetail = ({ movie }) => {
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      {
        text: 'The Girl in the Trunk - 2024',
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-the-girl-in-the-trunk-2024',
    name: 'Watch Movie The Girl in the Trunk (2024) | JWF™',
    alternateName: [
      'Ver película The Girl in the Trunk (2024) | JWF™',
      'Regarder le film The Girl in the Trunk (2024) | JWF™',
      'Film The Girl in the Trunk (2024) ansehen | JWF™',
      '观看电影 The Girl in the Trunk (2024) | JWF™',
      '映画 The Girl in the Trunk (2024) を見る | JWF™',
      '영화 The Girl in the Trunk (2024) 보기 | JWF™',
      'Assistir Filme The Girl in the Trunk (2024) | JWF™',
      'Guarda il film The Girl in the Trunk (2024) | JWF™',
      'Посмотреть фильм The Girl in the Trunk (2024) | JWF™',
      'مشاهدة فيلم The Girl in the Trunk (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie The Girl in the Trunk (2024) | JWF™</title>

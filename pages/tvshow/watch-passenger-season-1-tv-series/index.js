...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-passenger-season-1-tv-series',
    name: 'Watch Passenger Season 1 (2024) | JWF™',
    alternateName: [
      'Ver Passenger Temporada 1 (2024) | JWF™',
      'Regarder Passenger Saison 1 (2024) | JWF™',
      'Passenger Staffel 1 (2024) ansehen | JWF™',
      '观看黑暗物质 第一季 (2024) | JWF™',
      'ダークマター シーズン 1 (2024) を見る | JWF™',
      '다크 매터 시즌 1 (2024) 보기 | JWF™',
      'Assistir Passenger Temporada 1 (2024) | JWF™',
      'Guarda Passenger Stagione 1 (2024) | JWF™',
      'Посмотреть Passenger Сезон 1 (2024) | JWF™',
      'مشاهدة Passenger الموسم 1 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Passenger Season 1 (2024) | JWF™</title>

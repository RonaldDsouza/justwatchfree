...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-madgaon-express-2024',
    name: 'Watch Movie Madgaon Express (2024) | JWF™',
    alternateName: [
      'Ver película Madgaon Express (2024) | JWF™',
      'Regarder le film Madgaon Express (2024) | JWF™',
      'Film Madgaon Express (2024) ansehen | JWF™',
      '观看电影 Madgaon Express (2024) | JWF™',
      '映画 Madgaon Express (2024) を見る | JWF™',
      '영화 Madgaon Express (2024) 보기 | JWF™',
      'Assistir Filme Madgaon Express (2024) | JWF™',
      'Guarda il film Madgaon Express (2024) | JWF™',
      'Посмотреть фильм Madgaon Express (2024) | JWF™',
      'مشاهدة فيلم Madgaon Express (2024) | جي دبليو إف™'
    ]
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Madgaon Express (2024) | JWF™</title>

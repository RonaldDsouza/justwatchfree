...
const softwareSchema = JSON.stringify({
  ...
  headline: 'Watch Online Adult Content | Just Watch Free™',
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        ...
        <meta property='og:title' content=' Watch Online Adult |   JWF™' />
        <meta
          property='og:description'
          content='Welcome to  JWF™ – your go-to spot for free online adult! Watch and enjoy HD streaming, and catch the latest adults. Dive into cinema with  JWF™!'
        />

        <meta property='og:url' content='https://justwatchfree.vercel.app/adult' />

        <meta property='og:site_name' content=' JWF' />

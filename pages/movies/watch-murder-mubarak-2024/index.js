...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-murder-mubarak-2024',
    name: 'Watch Movie Murder Mubarak (2024) | JWF™',
    alternateName: [
      'Ver película Murder Mubarak (2024) | JWF™',
      'Regarder le film Murder Mubarak (2024) | JWF™',
      'Film Murder Mubarak (2024) ansehen | JWF™',
      '观看电影 Murder Mubarak (2024) | JWF™',
      '映画 Murder Mubarak (2024) を見る | JWF™',
      '영화 Murder Mubarak (2024) 보기 | JWF™',
      'Assistir Filme Murder Mubarak (2024) | JWF™',
      'Guarda il film Murder Mubarak (2024) | JWF™',
      'Посмотреть фильм Murder Mubarak (2024) | JWF™',
      'مشاهدة فيلم Murder Mubarak (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Murder Mubarak (2024) | JWF™</title>

...
const trailersDetail = ({ trailers }) => {
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      {
        text: 'Khel Khel Mein - 2024',
        url: 'https://www.imdb.com/title/tt27056012/'
      }
    ]
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Khel Khel Mein Official Trailer | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedTrailers = data.find(trailers => trailers.id === 'INDEX12')
  return {
    props: {

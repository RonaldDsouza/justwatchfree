...
const moviesDetail = ({ movie }) => {
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      {
        text: 'Beverly Hills Cop Axel F - 2024',
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-beverly-hills-cop-axel-f-2024',
    name: 'Watch Movie Beverly Hills Cop Axel F (2024) | JWF™',
    alternateName: [
      'Ver película Beverly Hills Cop Axel F (2024) | JWF™',
      'Regarder le film Beverly Hills Cop Axel F (2024) | JWF™',
      'Film Beverly Hills Cop Axel F (2024) ansehen | JWF™',
      '观看电影 Beverly Hills Cop Axel F (2024) | JWF™',
      '映画 Beverly Hills Cop Axel F (2024) を見る | JWF™',
      '영화 Beverly Hills Cop Axel F (2024) 보기 | JWF™',
      'Assistir Filme Beverly Hills Cop Axel F (2024) | JWF™',
      'Guarda il film Beverly Hills Cop Axel F (2024) | JWF™',
      'Посмотреть фильм Beverly Hills Cop Axel F (2024) | JWF™',
      'مشاهدة فيلم Beverly Hills Cop Axel F (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Beverly Hills Cop Axel F (2024) | JWF™</title>

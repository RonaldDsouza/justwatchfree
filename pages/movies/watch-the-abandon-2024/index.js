...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie The Abandon (2024) | JWF™',
    alternateName: [
      'Ver película The Abandon (2024) | JWF™',
      'Regarder le film The Abandon (2024) | JWF™',
      'Film The Abandon (2024) ansehen | JWF™',
      '观看电影 The Abandon (2024) | JWF™',
      '映画 The Abandon (2024) を見る | JWF™',
      '영화 The Abandon (2024) 보기 | JWF™',
      'Assistir Filme The Abandon (2024) | JWF™',
      'Guarda il film The Abandon (2024) | JWF™',
      'Посмотреть фильм The Abandon (2024) | JWF™',
      'مشاهدة فيلم The Abandon (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie The Abandon (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(movie => movie.id === 'INDEX46')
  return {
    props: {
      movie: selectedMovie
    }

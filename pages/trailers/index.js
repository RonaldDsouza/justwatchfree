...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://justwatchfree.vercel.app/trailers/',
  headline: 'Watch Online Trailers | JWF™',
  url: 'https://justwatchfree.vercel.app/trailers/',
  description:
    'Stream HD movies and TV series for free on Just Watch Free. Explore, stream, and download full-length movies and shows in HD quality without registration.',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Trailers',
      item: 'https://justwatchfree.vercel.app/trailers/'
    }
  ]
})
...
const trailersPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Latest Trailers | JWF™</title>
        <link rel='canonical' href='https://justwatchfree.vercel.app/trailers/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Watch Latest Trailers | JWF™' />
       ...
       <meta name="description" content="Stream HD movies and TV series for free on Just Watch Free. Explore, stream, and download full-length movies and shows in HD quality without registration."/>

        <meta property='og:url' content='https://justwatchfree.vercel.app/trailers' />
 ...
 <SocialSharing />
      ...
      {/* <Script src='../propler/ads2.js' defer /> */} 
        ...
        >
          Just Watch Free™ - Trailers Section.
        </h1>

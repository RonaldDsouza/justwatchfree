...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/adult/watch-kissa-part-02-2024',
    name: 'Watch Adult Kissa Part 02 (2024) | JWF™',
    alternateName: [
      'Ver Kissa Parte 02 (2024) para adultos | JWF™',
      'Regarder Kissa Partie 02 (2024) pour adultes | JWF™',
      'Kissa Teil 02 (2024) für Erwachsene ansehen | JWF™',
      '观看 Kissa 第02部分 (2024) 成人内容 | JWF™',
      'Kissa パート02 (2024) 大人向け | JWF™',
      'Kissa 파트 02 (2024) 성인 전용 | JWF™',
      'Assistir Kissa Parte 02 (2024) para adultos | JWF™',
      'Guarda Kissa Parte 02 (2024) per adulti | JWF™',
      'Посмотреть Kissa Часть 02 (2024) для взрослых | JWF™',
      'مشاهدة Kissa الجزء 02 (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Kissa Part 02 (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedAdult = data.find(adult => adult.id === 'INDEX22')
  return {
    props: {
      adult: selectedAdult
    }

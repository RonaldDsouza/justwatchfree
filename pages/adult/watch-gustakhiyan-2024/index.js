...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/adult/watch-gustakhiyan-2024',
    name: 'Watch Adult Gustakhiyan (2024) | JWF™',
    alternateName: [
      'Ver Gustakhiyan Parte (2024) para adultos | JWF™',
      'Regarder Gustakhiyan Partie (2024) pour adultes | JWF™',
      'Gustakhiyan Teil (2024) für Erwachsene ansehen | JWF™',
      '观看 Gustakhiyan (2024) 成人内容 | JWF™',
      'Gustakhiyan パート (2024) 大人向け | JWF™',
      'Gustakhiyan 파트 (2024) 성인 전용 | JWF™',
      'Assistir Gustakhiyan Parte (2024) para adultos | JWF™',
      'Guarda Gustakhiyan Parte (2024) per adulti | JWF™',
      'Посмотреть Gustakhiyan Часть (2024) для взрослых | JWF™',
      'مشاهدة Gustakhiyan (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Gustakhiyan (2024) | JWF™</title>

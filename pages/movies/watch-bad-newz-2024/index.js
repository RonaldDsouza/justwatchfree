...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-bad-newz-2024',
    name: 'Watch Movie Bad Newz (2024) | JWF™',
    alternateName: [
      'Ver película Bad Newz (2024) | JWF™',
      'Regarder le film Bad Newz (2024) | JWF™',
      'Film Bad Newz (2024) ansehen | JWF™',
      '观看电影 Bad Newz (2024) | JWF™',
      '映画 Bad Newz (2024) を見る | JWF™',
      '영화 Bad Newz (2024) 보기 | JWF™',
      'Assistir Filme Bad Newz (2024) | JWF™',
      'Guarda il film Bad Newz (2024) | JWF™',
      'Посмотреть фильм Bad Newz (2024) | JWF™',
      'مشاهدة فيلم Bad Newz (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Bad Newz (2024) | JWF™</title>

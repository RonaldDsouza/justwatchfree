...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-brinda-2024',
    name: 'Watch Movie Brinda (2024) | JWF™',
    alternateName: [
      'Ver película Brinda (2024) | JWF™',
      'Regarder le film Brinda (2024) | JWF™',
      'Film Brinda (2024) ansehen | JWF™',
      '观看电影 Brinda (2024) | JWF™',
      '映画 Brinda (2024) を見る | JWF™',
      '영화 Brinda (2024) 보기 | JWF™',
      'Assistir Filme Brinda (2024) | JWF™',
      'Guarda il film Brinda (2024) | JWF™',
      'Посмотреть фильм Brinda (2024) | JWF™',
      'مشاهدة فيلم Brinda (2024) | جي دبليو إف™'
    ]
   ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Brinda (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(movie => movie.id === 'INDEX47')
  return {
    props: {
      movie: selectedMovie
    }

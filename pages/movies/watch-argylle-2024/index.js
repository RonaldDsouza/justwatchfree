...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-argylle-2024',
    name: 'Watch Movie Argylle (2024) | JWF™',
    alternateName: [
      'Ver película Argylle (2024) | JWF™',
      'Regarder le film Argylle (2024) | JWF™',
      'Film Argylle (2024) ansehen | JWF™',
      '观看电影 Argylle (2024) | JWF™',
      '映画 Argylle (2024) を見る | JWF™',
      '영화 Argylle (2024) 보기 | JWF™',
      'Assistir Filme Argylle (2024) | JWF™',
      'Guarda il film Argylle (2024) | JWF™',
      'Посмотреть фильм Argylle (2024) | JWF™',
      'مشاهدة فيلم Argylle (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Argylle (2024) | JWF™</title>

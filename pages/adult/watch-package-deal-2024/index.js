...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/adult/watch-package-deal-2024',
    name: 'Watch Adult Package Deal (2024) | JWF™',
    alternateName: [
      'Ver Package Deal Parte (2024) para adultos | JWF™',
      'Regarder Package Deal Partie (2024) pour adultes | JWF™',
      'Package Deal Teil (2024) für Erwachsene ansehen | JWF™',
      '观看 Package Deal (2024) 成人内容 | JWF™',
      'Package Deal パート (2024) 大人向け | JWF™',
      'Package Deal 파트 (2024) 성인 전용 | JWF™',
      'Assistir Package Deal Parte (2024) para adultos | JWF™',
      'Guarda Package Deal Parte (2024) per adulti | JWF™',
      'Посмотреть Package Deal Часть (2024) для взрослых | JWF™',
      'مشاهدة Package Deal (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Package Deal (2024) | JWF™</title>

...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Adult Wild Dulhan (2024) | JWF™',
    alternateName: [
      'Ver Wild Dulhan Parte (2024) para adultos | JWF™',
      'Regarder Wild Dulhan Partie (2024) pour adultes | JWF™',
      'Wild Dulhan Teil (2024) für Erwachsene ansehen | JWF™',
      '观看 Wild Dulhan (2024) 成人内容 | JWF™',
      'Wild Dulhan パート (2024) 大人向け | JWF™',
      'Wild Dulhan 파트 (2024) 성인 전용 | JWF™',
      'Assistir Wild Dulhan Parte (2024) para adultos | JWF™',
      'Guarda Wild Dulhan Parte (2024) per adulti | JWF™',
      'Посмотреть Wild Dulhan Часть (2024) для взрослых | JWF™',
      'مشاهدة Wild Dulhan (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Wild Dulhan (2024) | JWF™</title>

...
const moviesDetail = ({ movie }) => {
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      {
        text: 'Bade Miyan Chote Miyan - 2024',
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-bade-miyan-chote-miyan-2024',
    name: 'Watch Movie Bade Miyan Chote Miyan (2024) | JWF™',
    alternateName: [
      'Ver película Bade Miyan Chote Miyan (2024) | JWF™',
      'Regarder le film Bade Miyan Chote Miyan (2024) | JWF™',
      'Film Bade Miyan Chote Miyan (2024) ansehen | JWF™',
      '观看电影 Bade Miyan Chote Miyan (2024) | JWF™',
      '映画 Bade Miyan Chote Miyan (2024) を見る | JWF™',
      '영화 Bade Miyan Chote Miyan (2024) 보기 | JWF™',
      'Assistir Filme Bade Miyan Chote Miyan (2024) | JWF™',
      'Guarda il film Bade Miyan Chote Miyan (2024) | JWF™',
      'Посмотреть фильм Bade Miyan Chote Miyan (2024) | JWF™',
      'مشاهدة فيلم Bade Miyan Chote Miyan (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Bade Miyan Chote Miyan (2024) | JWF™</title>

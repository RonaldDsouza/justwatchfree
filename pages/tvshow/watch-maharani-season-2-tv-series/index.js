...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Maharani Season 2 (2020) | JWF™',
    alternateName: [
      'Ver Maharani Temporada 2 (2024) | JWF™',
      'Regarder Maharani Saison 2 (2024) | JWF™',
      'Maharani Staffel 2 (2024) ansehen | JWF™',
      '观看黑暗物质 第一季 (2024) | JWF™',
      'ダークマター シーズン 2 (2024) を見る | JWF™',
      '다크 매터 시즌 2 (2024) 보기 | JWF™',
      'Assistir Maharani Temporada 2 (2024) | JWF™',
      'Guarda Maharani Stagione 2 (2024) | JWF™',
      'Посмотреть Maharani Сезон 2 (2024) | JWF™',
      'مشاهدة Maharani الموسم 2 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Maharani Season 2 (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedTvshow = data.find(tvshow => tvshow.id === 'INDEX29')
  return {
    props: {

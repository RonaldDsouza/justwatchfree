...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-36-days-2024',
    name: 'Watch Movie 36 Days (2024) | JWF™',
    alternateName: [
      'Ver película 36 días (2024) | JWF™',
      'Regarder le film 36 jours (2024) | JWF™',
      ...
      'مشاهدة الفيلم 36 يومًا (2024) | JWF™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie 36 Days (2024) | JWF™</title>

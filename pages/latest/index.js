...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://justwatchfree.vercel.app/latest/',
  headline: 'Entertainment News | JWF™',
  url: 'https://justwatchfree.vercel.app/latest/',
  description:
  ...
  image: 'https://justwatchfree.vercel.app/wp-content/uploads/browser.webp',
  author: {
    '@type': 'Person',
    name: 'DrTrailer',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: 'https://justwatchfree.vercel.app/latest/'
    }
  ]
})
...
const latestPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Entertainment News | JWF™</title>
        <link rel='canonical' href='https://justwatchfree.vercel.app/latest/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Entertainment News | JWF™' />
        <meta name="keywords" content="watch free movies, free movies online, download movies, full movies, HD movies, movie streaming, stream TV series, watch TV Series s free" />
         ...
         <meta name="description" content="Just Watch Free™ - Explore. Discover. Online. Stream online HD movies with Google Translate for access in any language, worldwide."/>


        <meta
          property='og:url'
          content='https://justwatchfree.vercel.app/latest'
        />
 ...
 <SocialSharing />
      ...
      >
        Just Watch Free™ - Latest Entertainment Section.
      </h1>
      {/* <Marquee /> */}
      {/* <p
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://justwatchfree.vercel.app/latest.json')

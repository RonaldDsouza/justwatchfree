...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-hierarchy-season-1-tv-series',
    name: 'Watch Hierarchy Season 1 (2024) | JWF™',
    alternateName: [
      'Ver Hierarchy Temporada 1 (2024) | JWF™',
      'Regarder Hierarchy Saison 1 (2024) | JWF™',
      'Hierarchy Staffel 1 (2024) ansehen | JWF™',
      '观看黑暗物质 第一季 (2024) | JWF™',
      'ダークマター シーズン 1 (2024) を見る | JWF™',
      '다크 매터 시즌 1 (2024) 보기 | JWF™',
      'Assistir Hierarchy Temporada 1 (2024) | JWF™',
      'Guarda Hierarchy Stagione 1 (2024) | JWF™',
      'Посмотреть Hierarchy Сезон 1 (2024) | JWF™',
      'مشاهدة Hierarchy الموسم 1 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Hierarchy Season 1 (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedTvshow = data.find(tvshow => tvshow.id === 'INDEX10')
  return {
    props: {

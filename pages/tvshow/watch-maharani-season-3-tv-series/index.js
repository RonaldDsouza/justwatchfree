...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Maharani Season 3 (2020) | JWF™',
    alternateName: [
      'Ver Maharani Temporada 3 (2024) | JWF™',
      'Regarder Maharani Saison 3 (2024) | JWF™',
      'Maharani Staffel 3 (2024) ansehen | JWF™',
      '观看黑暗物质 第一季 (2024) | JWF™',
      'ダークマター シーズン 3 (2024) を見る | JWF™',
      '다크 매터 시즌 3 (2024) 보기 | JWF™',
      'Assistir Maharani Temporada 3 (2024) | JWF™',
      'Guarda Maharani Stagione 3 (2024) | JWF™',
      'Посмотреть Maharani Сезон 3 (2024) | JWF™',
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Maharani Season 3 (2024) | JWF™</title>

...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-halo-season-1-tv-series',
    name: 'Watch Halo Season 1 (2020) | JWF™',
    alternateName: [
      'Ver Halo Temporada 1 (2024) | JWF™',
      'Regarder Halo Saison 1 (2024) | JWF™',
      'Halo Staffel 1 (2024) ansehen | JWF™',
      '观看黑暗物质 第一季 (2024) | JWF™',
      'ダークマター シーズン 1 (2024) を見る | JWF™',
      '다크 매터 시즌 1 (2024) 보기 | JWF™',
      'Assistir Halo Temporada 1 (2024) | JWF™',
      'Guarda Halo Stagione 1 (2024) | JWF™',
      'Посмотреть Halo Сезон 1 (2024) | JWF™',
      'مشاهدة Halo الموسم 1 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Halo Season 1 (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedTvshow = data.find(tvshow => tvshow.id === 'INDEX20')
  return {
    props: {

...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-tuesday-2024',
    name: 'Watch Movie Tuesday (2024) | JWF™',
    alternateName: [
      'Ver película Tuesday (2024) | JWF™',
      'Regarder le film Tuesday (2024) | JWF™',
      'Film Tuesday (2024) ansehen | JWF™',
      '观看电影 Tuesday (2024) | JWF™',
      '映画 Tuesday (2024) を見る | JWF™',
      '영화 Tuesday (2024) 보기 | JWF™',
      'Assistir Filme Tuesday (2024) | JWF™',
      'Guarda il film Tuesday (2024) | JWF™',
      'Посмотреть фильм Tuesday (2024) | JWF™',
      'مشاهدة فيلم Tuesday (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Tuesday (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(movie => movie.id === 'INDEX50')
  return {
    props: {
      movie: selectedMovie
    }

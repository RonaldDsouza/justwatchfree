...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/adult/watch-init-2024',
    name: 'Watch Adult Init (2024) | JWF™',
    alternateName: [
      'Ver Init Parte (2024) para adultos | JWF™',
      'Regarder Init Partie (2024) pour adultes | JWF™',
      'Init Teil (2024) für Erwachsene ansehen | JWF™',
      '观看 Init (2024) 成人内容 | JWF™',
      'Init パート (2024) 大人向け | JWF™',
      'Init 파트 (2024) 성인 전용 | JWF™',
      'Assistir Init Parte (2024) para adultos | JWF™',
      'Guarda Init Parte (2024) per adulti | JWF™',
      'Посмотреть Init Часть (2024) для взрослых | JWF™',
      'مشاهدة Init (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Init (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedAdult = data.find(adult => adult.id === 'INDEX18')
  return {
    props: {
      adult: selectedAdult
    }

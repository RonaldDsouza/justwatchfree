...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-daddio-2024',
    name: 'Watch Movie Daddio (2024) | JWF™',
    alternateName: [
      'Ver película Daddio (2024) | JWF™',
      'Regarder le film Daddio (2024) | JWF™',
      'Film Daddio (2024) ansehen | JWF™',
      '观看电影 Daddio (2024) | JWF™',
      '映画 Daddio (2024) を見る | JWF™',
      '영화 Daddio (2024) 보기 | JWF™',
      'Assistir Filme Daddio (2024) | JWF™',
      'Guarda il film Daddio (2024) | JWF™',
      'Посмотреть фильм Daddio (2024) | JWF™',
      'مشاهدة فيلم Daddio (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Daddio (2024) | JWF™</title>

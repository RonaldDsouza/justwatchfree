...
const MoviePage = ({ movies }) => {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      {
        '@type': 'WebSite',
        '@id': 'https://justwatchfree.vercel.app/movies/#website',
      ...
      {
        '@type': 'WebPage',
        '@id': 'https://justwatchfree.vercel.app/movies/#webpage',
        url: 'https://justwatchfree.vercel.app/movies',
        name: 'Movie',
  ...
  const languagesSchema = JSON.stringify({
    ...
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies',
    name: 'Just Watch Free™ - Movies',
    alternateName: [
      'Just Watch Free™ - Películas',
      'Just Watch Free™ - Films',
      'Just Watch Free™ - Filme',
      'Just Watch Free™ - 电影',
      'Just Watch Free™ - 映画',
      'Just Watch Free™ - 영화',
      'Just Watch Free™ - Filmes',
      'Just Watch Free™ - Film',
      'Just Watch Free™ - Фильмы',
      'Just Watch Free™ - أفلام'
    ],
    inLanguage: [

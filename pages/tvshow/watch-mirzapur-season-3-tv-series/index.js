...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-mirzapur-season-3-tv-series',
    name: 'Watch Mirzapur Season 3 (2024) | JWF™',
    alternateName: [
      'Ver Mirzapur Temporada 3 (2024) | JWF™',
      'Regarder Mirzapur Saison 3 (2024) | JWF™',
      'Mirzapur Staffel 3 (2024) ansehen | JWF™',
      '观看 Mirzapur 第三季 (2024) | JWF™',
      'ミルザプール シーズン 3 (2024) を見る | JWF™',
      '미르자푸르 시즌 3 (2024) 보기 | JWF™',
      'Assistir Mirzapur Temporada 3 (2024) | JWF™',
      'Guarda Mirzapur Stagione 3 (2024) | JWF™',
      'Посмотреть Mirzapur Сезон 3 (2024) | JWF™',
      'مشاهدة Mirzapur الموسم 3 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Mirzapur Season 3 (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedTvshow = data.find(tvshow => tvshow.id === 'INDEX08')
  return {
    props: {

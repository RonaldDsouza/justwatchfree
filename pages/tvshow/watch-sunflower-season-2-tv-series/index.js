...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-sunflower-season-2-tv-series',
    name: 'Watch Sunflower Season 2 (2020) | JWF™',
    alternateName: [
      'Ver Sunflower Temporada 2 (2024) | JWF™',
      'Regarder Sunflower Saison 2 (2024) | JWF™',
      'Sunflower Staffel 2 (2024) ansehen | JWF™',
      '观看黑暗物质 第一季 (2024) | JWF™',
      'ダークマター シーズン 2 (2024) を見る | JWF™',
      '다크 매터 시즌 2 (2024) 보기 | JWF™',
      'Assistir Sunflower Temporada 2 (2024) | JWF™',
      'Guarda Sunflower Stagione 2 (2024) | JWF™',
      'Посмотреть Sunflower Сезон 2 (2024) | JWF™',
      'مشاهدة Sunflower الموسم 2 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Sunflower Season 2 (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedTvshow = data.find(tvshow => tvshow.id === 'INDEX05')
  return {
    props: {

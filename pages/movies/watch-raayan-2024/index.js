...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-raayan-2024',
    name: 'Watch Movie Raayan (2024) | JWF™',
    alternateName: [
      'Ver película Raayan (2024) | JWF™',
      'Regarder le film Raayan (2024) | JWF™',
      'Film Raayan (2024) ansehen | JWF™',
      '观看电影 Raayan (2024) | JWF™',
      '映画 Raayan (2024) を見る | JWF™',
      '영화 Raayan (2024) 보기 | JWF™',
      'Assistir Filme Raayan (2024) | JWF™',
      'Guarda il film Raayan (2024) | JWF™',
      'Посмотреть фильм Raayan (2024) | JWF™',
      'مشاهدة فيلم Raayan (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Raayan (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(movie => movie.id === 'INDEX45')
  return {
    props: {
      movie: selectedMovie
    }

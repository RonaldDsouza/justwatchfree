...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-gangs-of-godavari-2024',
    name: 'Watch Movie Gangs Of Godavari (2024) | JWF™',
    alternateName: [
      'Ver película Gangs Of Godavari (2024) | JWF™',
      'Regarder le film Gangs Of Godavari (2024) | JWF™',
      'Film Gangs Of Godavari (2024) ansehen | JWF™',
      '观看电影 Gangs Of Godavari (2024) | JWF™',
      '映画 Gangs Of Godavari (2024) を見る | JWF™',
      '영화 Gangs Of Godavari (2024) 보기 | JWF™',
      'Assistir Filme Gangs Of Godavari (2024) | JWF™',
      'Guarda il film Gangs Of Godavari (2024) | JWF™',
      'Посмотреть фильм Gangs Of Godavari (2024) | JWF™',
      'مشاهدة فيلم Gangs Of Godavari (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Gangs Of Godavari (2024) | JWF™</title>

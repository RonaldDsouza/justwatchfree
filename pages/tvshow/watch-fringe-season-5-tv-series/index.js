...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-fringe-season-5-tv-series',
    name: 'Watch Fringe Season 5 (2024) | JWF™',
    alternateName: [
      'Ver Fringe Temporada 5 (2024) | JWF™',
      'Regarder Fringe Saison 5 (2024) | JWF™',
      'Fringe Staffel 5 (2024) ansehen | JWF™',
      '观看黑暗物质 第一季 (2024) | JWF™',
      'ダークマター シーズン 5 (2024) を見る | JWF™',
      '다크 매터 시즌 5 (2024) 보기 | JWF™',
      'Assistir Fringe Temporada 5 (2024) | JWF™',
      'Guarda Fringe Stagione 5 (2024) | JWF™',
      'Посмотреть Fringe Сезон 5 (2024) | JWF™',
      'مشاهدة Fringe الموسم 5 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Fringe Season 5 (2024) | JWF™</title>

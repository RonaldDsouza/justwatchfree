...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/adult/watch-mastani-shabbo-2024',
    name: 'Watch Adult Mastani Shabbo (2024) | JWF™',
    alternateName: [
      'Ver Mastani Shabbo Parte (2024) para adultos | JWF™',
      'Regarder Mastani Shabbo Partie (2024) pour adultes | JWF™',
      'Mastani Shabbo Teil (2024) für Erwachsene ansehen | JWF™',
      '观看 Mastani Shabbo (2024) 成人内容 | JWF™',
      'Mastani Shabbo パート (2024) 大人向け | JWF™',
      'Mastani Shabbo 파트 (2024) 성인 전용 | JWF™',
      'Assistir Mastani Shabbo Parte (2024) para adultos | JWF™',
      'Guarda Mastani Shabbo Parte (2024) per adulti | JWF™',
      'Посмотреть Mastani Shabbo Часть (2024) для взрослых | JWF™',
      'مشاهدة Mastani Shabbo (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Mastani Shabbo (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedAdult = data.find(adult => adult.id === 'INDEX13')
  return {
    props: {
      adult: selectedAdult
    }

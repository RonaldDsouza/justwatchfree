...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-wild-eyed-and-wicked-2024',
    name: 'Watch Movie Wild Eyed & Wicked (2024) | JWF™',
    alternateName: [
      'Ver película Wild Eyed & Wicked (2024) | JWF™',
      'Regarder le film Wild Eyed & Wicked (2024) | JWF™',
      'Film Wild Eyed & Wicked (2024) ansehen | JWF™',
      '观看电影 Wild Eyed & Wicked (2024) | JWF™',
      '映画 Wild Eyed & Wicked (2024) を見る | JWF™',
      '영화 Wild Eyed & Wicked (2024) 보기 | JWF™',
      'Assistir Filme Wild Eyed & Wicked (2024) | JWF™',
      'Guarda il film Wild Eyed & Wicked (2024) | JWF™',
      'Посмотреть фильм Wild Eyed & Wicked (2024) | JWF™',
      'مشاهدة فيلم Wild Eyed & Wicked (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Wild Eyed & Wicked (2024) | JWF™</title>

...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-a-sacrifice-2024',
    name: 'Watch Movie A Sacrifice (2024) | JWF™',
    alternateName: [
      'Ver película Un sacrificio (2024) | JWF™',
      'Regarder le film Un sacrifice (2024) | JWF™',
      'Film Ein Opfer (2024) ansehen | JWF™',
      '观看电影 牺牲 (2024) | JWF™',
      '映画 犠牲 (2024) を見る | JWF™',
      '영화 희생 (2024) 보기 | JWF™',
      'Assistir Filme Um Sacrifício (2024) | JWF™',
      'Guarda il film Un sacrificio (2024) | JWF™',
      'Посмотреть фильм Жертва (2024) | JWF™',
      'مشاهدة فيلم تضحية (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie A Sacrifice (2024) | JWF™</title>

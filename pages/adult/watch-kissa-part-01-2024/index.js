...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/adult/watch-kissa-part-01-2024',
    name: 'Watch Adult Kissa  Part 01 (2024) | JWF™',
    alternateName: [
      'Ver Kissa Parte 01 (2024) para adultos | JWF™',
      'Regarder Kissa Partie 01 (2024) pour adultes | JWF™',
      'Kissa Teil 01 (2024) für Erwachsene ansehen | JWF™',
      '观看 Kissa  第01部分 (2024) 成人内容 | JWF™',
      'Kissa パート01 (2024) 大人向け | JWF™',
      'Kissa 파트 01 (2024) 성인 전용 | JWF™',
      'Assistir Kissa Parte 01 (2024) para adultos | JWF™',
      'Guarda Kissa Parte 01 (2024) per adulti | JWF™',
      'Посмотреть Kissa Часть 01 (2024) для взрослых | JWF™',
      'مشاهدة Kissa الجزء 01 (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Kissa Part 01 (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedAdult = data.find(adult => adult.id === 'INDEX20')
  return {
    props: {
      adult: selectedAdult
    }

...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-the-watchers-2024',
    name: 'Watch Movie The Watchers (2024) | JWF™',
    alternateName: [
      'Ver película The Watchers (2024) | JWF™',
      'Regarder le film The Watchers (2024) | JWF™',
      'Film The Watchers (2024) ansehen | JWF™',
      '观看电影 The Watchers (2024) | JWF™',
      '映画 The Watchers (2024) を見る | JWF™',
      '영화 The Watchers (2024) 보기 | JWF™',
      'Assistir Filme The Watchers (2024) | JWF™',
      'Guarda il film The Watchers (2024) | JWF™',
      'Посмотреть фильм The Watchers (2024) | JWF™',
      'مشاهدة فيلم The Watchers (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie The Watchers (2024) | JWF™</title>

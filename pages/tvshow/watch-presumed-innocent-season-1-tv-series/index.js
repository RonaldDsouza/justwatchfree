...
const tvshowDetail = ({ tvshow }) => {
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      {
        text: 'Presumed Innocent Season 1 - 2024',
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-presumed-innocent-season-1-tv-series',
    name: 'Watch Presumed Innocent Season 1 (2024) | JWF™',
    alternateName: [
      'Ver Presumed Innocent Temporada 1 (2024) | JWF™',
      'Regarder Presumed Innocent Saison 1 (2024) | JWF™',
      'Presumed Innocent Staffel 1 (2024) ansehen | JWF™',
      '观看黑暗物质 第一季 (2024) | JWF™',
      'ダークマター シーズン 1 (2024) を見る | JWF™',
      '다크 매터 시즌 1 (2024) 보기 | JWF™',
      'Assistir Presumed Innocent Temporada 1 (2024) | JWF™',
      'Guarda Presumed Innocent Stagione 1 (2024) | JWF™',
      'Посмотреть Presumed Innocent Сезон 1 (2024) | JWF™',
      'مشاهدة Presumed Innocent الموسم 1 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Presumed Innocent Season 1 (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedTvshow = data.find(tvshow => tvshow.id === 'INDEX22')
  return {
    props: {

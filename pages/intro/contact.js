...
const contact = () => {
  ...
  return (
    <div>
      <Head>
        <title>Just Watch Free™ | Contact Us</title>
        ...
        <link
          ...
          />
          <link rel='canonical' href='https://justwatchfree.vercel.app/contact/' />
          ...
          />
          <meta property='og:url' content='https://justwatchfree.vercel.app/contact/' />
          <meta
          ...
          <div className='flex flex-wrap'>
            <div className='grow-0 shrink-0 basis-auto mb-6 md:mb-0 w-full md:w-6/12 px-3 lg:px-6'>
              ...
              <p className='text-gray-500 mb-6'>
                ...
                related to Just Watch Free™. We welcome your input to help us

...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/adult/watch-pretty-boys-2024',
    name: 'Watch Adult Pretty Boys (2024) | JWF™',
    alternateName: [
      'Ver Pretty Boys Parte (2024) para adultos | JWF™',
      'Regarder Pretty Boys Partie (2024) pour adultes | JWF™',
      'Pretty Boys Teil (2024) für Erwachsene ansehen | JWF™',
      '观看 Pretty Boys (2024) 成人内容 | JWF™',
      'Pretty Boys パート (2024) 大人向け | JWF™',
      'Pretty Boys 파트 (2024) 성인 전용 | JWF™',
      'Assistir Pretty Boys Parte (2024) para adultos | JWF™',
      'Guarda Pretty Boys Parte (2024) per adulti | JWF™',
      'Посмотреть Pretty Boys Часть (2024) для взрослых | JWF™',
      'مشاهدة Pretty Boys (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Pretty Boys (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedAdult = data.find(adult => adult.id === 'INDEX21')
  return {
    props: {
      adult: selectedAdult
    }

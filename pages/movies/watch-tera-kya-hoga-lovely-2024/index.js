...
const moviesDetail = ({ movie }) => {
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      {
        text: 'Tera Kya Hoga Lovely - 2024',
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-the-abandon-2024',
    name: 'Watch Movie Tera Kya Hoga Lovely (2024) | JWF™',
    alternateName: [
      'Ver película Tera Kya Hoga Lovely (2024) | JWF™',
      'Regarder le film Tera Kya Hoga Lovely (2024) | JWF™',
      'Film Tera Kya Hoga Lovely (2024) ansehen | JWF™',
      '观看电影 Tera Kya Hoga Lovely (2024) | JWF™',
      '映画 Tera Kya Hoga Lovely (2024) を見る | JWF™',
      '영화 Tera Kya Hoga Lovely (2024) 보기 | JWF™',
      'Assistir Filme Tera Kya Hoga Lovely (2024) | JWF™',
      'Guarda il film Tera Kya Hoga Lovely (2024) | JWF™',
      'Посмотреть фильм Tera Kya Hoga Lovely (2024) | JWF™',
      'مشاهدة فيلم Tera Kya Hoga Lovely (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Tera Kya Hoga Lovely (2024) | JWF™</title>

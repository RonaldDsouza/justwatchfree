...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-hard-home-2024',
    name: 'Watch Movie Hard Home (2024) | JWF™',
    alternateName: [
      'Ver película Hard Home (2024) | JWF™',
      'Regarder le film Hard Home (2024) | JWF™',
      'Film Hard Home (2024) ansehen | JWF™',
      '观看电影 Hard Home (2024) | JWF™',
      '映画 Hard Home (2024) を見る | JWF™',
      '영화 Hard Home (2024) 보기 | JWF™',
      'Assistir Filme Hard Home (2024) | JWF™',
      'Guarda il film Hard Home (2024) | JWF™',
      'Посмотреть фильм Hard Home (2024) | JWF™',
      'مشاهدة فيلم Hard Home (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Hard Home (2024) | JWF™</title>

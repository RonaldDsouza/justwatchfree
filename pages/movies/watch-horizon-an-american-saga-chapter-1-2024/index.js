...
const moviesDetail = ({ movie }) => {
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      {
        text: 'Horizon: An American Saga Chapter 1 - 2024',
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-harom-hara-2024',
    name: 'Watch Movie Horizon: An American Saga Chapter 1 (2024) | JWF™',
    alternateName: [
      'Ver película Horizon: An American Saga Chapter 1 (2024) | JWF™',
      'Regarder le film Horizon: An American Saga Chapter 1 (2024) | JWF™',
      'Film Horizon: An American Saga Chapter 1 (2024) ansehen | JWF™',
      '观看电影 Horizon: An American Saga Chapter 1 (2024) | JWF™',
      '映画 Horizon: An American Saga Chapter 1 (2024) を見る | JWF™',
      '영화 Horizon: An American Saga Chapter 1 (2024) 보기 | JWF™',
      'Assistir Filme Horizon: An American Saga Chapter 1 (2024) | JWF™',
      'Guarda il film Horizon: An American Saga Chapter 1 (2024) | JWF™',
      'Посмотреть фильм Horizon: An American Saga Chapter 1 (2024) | JWF™',
      'مشاهدة فيلم Horizon: An American Saga Chapter 1 (2024) | جي دبليو إف™'
    ]
   ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Horizon: An American Saga Chapter 1 (2024) | JWF™</title>

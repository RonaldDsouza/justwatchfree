...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/adult/watch-lady-guard-2024',
    name: 'Watch Adult Lady Guard (2024) | JWF™',
    alternateName: [
      'Ver Lady Guard Parte (2024) para adultos | JWF™',
      'Regarder Lady Guard Partie (2024) pour adultes | JWF™',
      'Lady Guard Teil (2024) für Erwachsene ansehen | JWF™',
      '观看 Lady Guard (2024) 成人内容 | JWF™',
      'Lady Guard パート (2024) 大人向け | JWF™',
      'Lady Guard 파트 (2024) 성인 전용 | JWF™',
      'Assistir Lady Guard Parte (2024) para adultos | JWF™',
      'Guarda Lady Guard Parte (2024) per adulti | JWF™',
      'Посмотреть Lady Guard Часть (2024) для взрослых | JWF™',
      'مشاهدة Lady Guard (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Lady Guard (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedAdult = data.find(adult => adult.id === 'INDEX05')
  return {
    props: {
      adult: selectedAdult
    }

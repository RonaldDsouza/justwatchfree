...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-the-crew-2024',
    name: 'Watch Movie Crew (2024) | JWF™',
    alternateName: [
      'Ver película Crew (2024) | JWF™',
      'Regarder le film Crew (2024) | JWF™',
      'Film Crew (2024) ansehen | JWF™',
      '观看电影 Crew (2024) | JWF™',
      '映画 Crew (2024) を見る | JWF™',
      '영화 Crew (2024) 보기 | JWF™',
      'Assistir Filme Crew (2024) | JWF™',
      'Guarda il film Crew (2024) | JWF™',
      'Посмотреть фильм Crew (2024) | JWF™',
      'مشاهدة فيلم Crew (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Crew (2024) | JWF™</title>

...
const tvshowDetail = ({ tvshow }) => {
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      {
        text: 'Dark Matter Season 1 - 2024',
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-dark-matter-season-1-tv-series',
    name: 'Watch Dark Matter Season 1 (2024) | JWF™',
    alternateName: [
      'Ver Dark Matter Temporada 1 (2024) | JWF™',
      'Regarder Dark Matter Saison 1 (2024) | JWF™',
      'Dark Matter Staffel 1 (2024) ansehen | JWF™',
      '观看黑暗物质 第一季 (2024) | JWF™',
      'ダークマター シーズン 1 (2024) を見る | JWF™',
      '다크 매터 시즌 1 (2024) 보기 | JWF™',
      'Assistir Dark Matter Temporada 1 (2024) | JWF™',
      'Guarda Dark Matter Stagione 1 (2024) | JWF™',
      'Посмотреть Dark Matter Сезон 1 (2024) | JWF™',
      'مشاهدة Dark Matter الموسم 1 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Dark Matter Season 1 (2024) | JWF™</title>

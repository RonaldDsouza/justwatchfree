...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-arcadian-2024',
    name: 'Watch Movie Arcadian (2024) | JWF™',
    alternateName: [
      'Ver película Arcadian (2024) | JWF™',
      'Regarder le film Arcadian (2024) | JWF™',
      'Film Arcadian (2024) ansehen | JWF™',
      '观看电影 Arcadian (2024) | JWF™',
      '映画 Arcadian (2024) を見る | JWF™',
      '영화 Arcadian (2024) 보기 | JWF™',
      'Assistir Filme Arcadian (2024) | JWF™',
      'Guarda il film Arcadian (2024) | JWF™',
      'Посмотреть фильм Arcadian (2024) | JWF™',
      'مشاهدة فيلم Arcadian (2024) | جي دبليو إف™'
    ]    
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Arcadian (2024) | JWF™</title>

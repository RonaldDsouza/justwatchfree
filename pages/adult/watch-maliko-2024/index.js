...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/adult/watch-maliko-2024',
    name: 'Watch Adult Maliko (2024) | JWF™',
    alternateName: [
      'Ver Maliko Parte (2024) para adultos | JWF™',
      'Regarder Maliko Partie (2024) pour adultes | JWF™',
      'Maliko Teil (2024) für Erwachsene ansehen | JWF™',
      '观看 Maliko (2024) 成人内容 | JWF™',
      'Maliko パート (2024) 大人向け | JWF™',
      'Maliko 파트 (2024) 성인 전용 | JWF™',
      'Assistir Maliko Parte (2024) para adultos | JWF™',
      'Guarda Maliko Parte (2024) per adulti | JWF™',
      'Посмотреть Maliko Часть (2024) для взрослых | JWF™',
      'مشاهدة Maliko (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Maliko (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedAdult = data.find(adult => adult.id === 'INDEX01')
  return {
    props: {
      adult: selectedAdult
    }

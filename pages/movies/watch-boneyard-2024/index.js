...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-boneyard-2024',
    name: 'Watch Movie Boneyard (2024) | JWF™',
    alternateName: [
      'Ver película Boneyard (2024) | JWF™',
      'Regarder le film Boneyard (2024) | JWF™',
      'Film Boneyard (2024) ansehen | JWF™',
      '观看电影 Boneyard (2024) | JWF™',
      '映画 Boneyard (2024) を見る | JWF™',
      '영화 Boneyard (2024) 보기 | JWF™',
      'Assistir Filme Boneyard (2024) | JWF™',
      'Guarda il film Boneyard (2024) | JWF™',
      'Посмотреть фильм Boneyard (2024) | JWF™',
      'مشاهدة فيلم Boneyard (2024) | جي دبليو إف™'
    ]
   ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Boneyard (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(movie => movie.id === 'INDEX23A')
  return {
    props: {
      movie: selectedMovie
    }

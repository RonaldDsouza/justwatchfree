...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-twisters-2024',
    name: 'Watch Movie Twisters (2024) | JWF™',
    alternateName: [
      'Ver película Twisters (2024) | JWF™',
      'Regarder le film Twisters (2024) | JWF™',
      'Film Twisters (2024) ansehen | JWF™',
      '观看电影 Twisters (2024) | JWF™',
      '映画 Twisters (2024) を見る | JWF™',
      '영화 Twisters (2024) 보기 | JWF™',
      'Assistir Filme Twisters (2024) | JWF™',
      'Guarda il film Twisters (2024) | JWF™',
      'Посмотреть фильм Twisters (2024) | JWF™',
      'مشاهدة فيلم Twisters (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Twisters (2024) | JWF™</title>

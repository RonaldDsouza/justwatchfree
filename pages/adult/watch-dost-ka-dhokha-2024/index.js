...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/adult/watch-dost-ka-dhokha-2024',
    name: 'Watch Adult Dost Ka Dhokha (2024) | JWF™',
    alternateName: [
      'Ver Dost Ka Dhokha Parte (2024) para adultos | JWF™',
      'Regarder Dost Ka Dhokha Partie (2024) pour adultes | JWF™',
      'Dost Ka Dhokha Teil (2024) für Erwachsene ansehen | JWF™',
      '观看 Dost Ka Dhokha (2024) 成人内容 | JWF™',
      'Dost Ka Dhokha パート (2024) 大人向け | JWF™',
      'Dost Ka Dhokha 파트 (2024) 성인 전용 | JWF™',
      'Assistir Dost Ka Dhokha Parte (2024) para adultos | JWF™',
      'Guarda Dost Ka Dhokha Parte (2024) per adulti | JWF™',
      'Посмотреть Dost Ka Dhokha Часть (2024) для взрослых | JWF™',
      'مشاهدة Dost Ka Dhokha (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Dost Ka Dhokha (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedAdult = data.find(adult => adult.id === 'INDEX08')
  return {
    props: {
      adult: selectedAdult
    }

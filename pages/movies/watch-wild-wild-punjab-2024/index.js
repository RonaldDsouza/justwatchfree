...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-wild-wild-punjab-2024',
    name: 'Watch Movie Wild Wild Punjab (2024) | JWF™',
    alternateName: [
      'Ver película Wild Wild Punjab (2024) | JWF™',
      'Regarder le film Wild Wild Punjab (2024) | JWF™',
      'Film Wild Wild Punjab (2024) ansehen | JWF™',
      '观看电影 Wild Wild Punjab (2024) | JWF™',
      '映画 Wild Wild Punjab (2024) を見る | JWF™',
      '영화 Wild Wild Punjab (2024) 보기 | JWF™',
      'Assistir Filme Wild Wild Punjab (2024) | JWF™',
      'Guarda il film Wild Wild Punjab (2024) | JWF™',
      'Посмотреть фильм Wild Wild Punjab (2024) | JWF™',
      'مشاهدة فيلم Wild Wild Punjab (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Wild Wild Punjab (2024) | JWF™</title>

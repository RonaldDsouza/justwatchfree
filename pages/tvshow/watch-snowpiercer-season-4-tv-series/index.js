...
const tvshowDetail = ({ tvshow }) => {
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      {
        text: 'Snowpiercer Season 4 - 2024',
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-snowpiercer-season-4-tv-series',
    name: 'Watch Snowpiercer Season 4 (2024) | JWF™',
    alternateName: [
      'Ver Snowpiercer Temporada 4 (2024) | JWF™',
      'Regarder Snowpiercer Saison 4 (2024) | JWF™',
      'Snowpiercer Staffel 5 (2024) ansehen | JWF™',
      '观看黑暗物质 第一季 (2024) | JWF™',
      'ダークマター シーズン 4 (2024) を見る | JWF™',
      '다크 매터 시즌 4 (2024) 보기 | JWF™',
      'Assistir Snowpiercer Temporada 4 (2024) | JWF™',
      'Guarda Snowpiercer Stagione 4 (2024) | JWF™',
      'Посмотреть Snowpiercer Сезон 4 (2024) | JWF™',
      'مشاهدة Snowpiercer الموسم 4 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Snowpiercer Season 4 (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedTvshow = data.find(tvshow => tvshow.id === 'INDEX24')
  return {
    props: {

...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-fake-season-1-tv-series',
    name: 'Watch Fake Season 1 (2024) | JWF™',
    alternateName: [
      'Ver Fake Temporada 1 (2024) | JWF™',
      'Regarder Fake Saison 1 (2024) | JWF™',
      'Fake Staffel 1 (2024) ansehen | JWF™',
      '观看黑暗物质 第一季 (2024) | JWF™',
      'ダークマター シーズン 1 (2024) を見る | JWF™',
      '다크 매터 시즌 1 (2024) 보기 | JWF™',
      'Assistir Fake Temporada 1 (2024) | JWF™',
      'Guarda Fake Stagione 1 (2024) | JWF™',
      'Посмотреть Fake Сезон 1 (2024) | JWF™',
      'مشاهدة Fake الموسم 1 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Fake Season 1 (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedTvshow = data.find(tvshow => tvshow.id === 'INDEX11')
  return {
    props: {

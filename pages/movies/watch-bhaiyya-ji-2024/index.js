...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-bhaiyya-ji-2024',
    name: 'Watch Movie Bhaiyya Ji (2024) | JWF™',
    alternateName: [
      'Ver película Bhaiyya Ji (2024) | JWF™',
      'Regarder le film Bhaiyya Ji (2024) | JWF™',
      'Film Bhaiyya Ji (2024) ansehen | JWF™',
      '观看电影 Bhaiyya Ji (2024) | JWF™',
      '映画 Bhaiyya Ji (2024) を見る | JWF™',
      '영화 Bhaiyya Ji (2024) 보기 | JWF™',
      'Assistir Filme Bhaiyya Ji (2024) | JWF™',
      'Guarda il film Bhaiyya Ji (2024) | JWF™',
      'Посмотреть фильм Bhaiyya Ji (2024) | JWF™',
      'مشاهدة فيلم Bhaiyya Ji (2024) | جي دبليو إف™'
    ]
   ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Bhaiyya Ji (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(movie => movie.id === 'INDEX44')
  return {
    props: {
      movie: selectedMovie
    }

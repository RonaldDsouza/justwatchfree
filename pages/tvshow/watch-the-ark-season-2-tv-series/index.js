...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-the-ark-season-2-tv-series',
    name: 'Watch The Ark Season 2 (2024) | JWF™',
    alternateName: [
      'Ver The Ark Temporada 2 (2024) | JWF™',
      'Regarder The Ark Saison 2 (2024) | JWF™',
      'The Ark Staffel 2 (2024) ansehen | JWF™',
      '观看黑暗物质 第一季 (2024) | JWF™',
      'ダークマター シーズン 2 (2024) を見る | JWF™',
      '다크 매터 시즌 2 (2024) 보기 | JWF™',
      'Assistir The Ark Temporada 2 (2024) | JWF™',
      'Guarda The Ark Stagione 2 (2024) | JWF™',
      'Посмотреть The Ark Сезон 2 (2024) | JWF™',
      'مشاهدة The Ark الموسم2 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch The Ark Season 2 (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedTvshow = data.find(tvshow => tvshow.id === 'INDEX18')
  return {
    props: {

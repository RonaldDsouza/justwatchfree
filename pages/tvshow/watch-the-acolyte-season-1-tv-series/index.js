...
const tvshowDetail = ({ tvshow }) => {
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      {
        text: 'The Acolyte Season 1 - 2024',
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/tvshow/watch-the-acolyte-season-1-tv-series',
    name: 'Watch The Acolyte Season 1 (2024) | JWF™',
    alternateName: [
      'Ver The Acolyte Temporada 1 (2024) | JWF™',
      'Regarder The Acolyte Saison 1 (2024) | JWF™',
      'The Acolyte Staffel 1 (2024) ansehen | JWF™',
      '观看黑暗物质 第一季 (2024) | JWF™',
      'ダークマター シーズン 1 (2024) を見る | JWF™',
      '다크 매터 시즌 1 (2024) 보기 | JWF™',
      'Assistir The Acolyte Temporada 1 (2024) | JWF™',
      'Guarda The Acolyte Stagione 1 (2024) | JWF™',
      'Посмотреть The Acolyte Сезон 1 (2024) | JWF™',
      'مشاهدة The Acolyte الموسم 1 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch The Acolyte Season 1 (2024) | JWF™</title>

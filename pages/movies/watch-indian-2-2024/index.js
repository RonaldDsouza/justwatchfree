...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-indian-2-2024',
    name: 'Watch Movie Indian 2 (2024) | JWF™',
    alternateName: [
      'Ver película Indian 2 (2024) | JWF™',
      'Regarder le film Indian 2 (2024) | JWF™',
      'Film Indian 2 (2024) ansehen | JWF™',
      '观看电影 Indian 2 (2024) | JWF™',
      '映画 Indian 2 (2024) を見る | JWF™',
      '영화 Indian 2 (2024) 보기 | JWF™',
      'Assistir Filme Indian 2 (2024) | JWF™',
      'Guarda il film Indian 2 (2024) | JWF™',
      'Посмотреть фильм Indian 2 (2024) | JWF™',
      'مشاهدة فيلم Indian 2 (2024) | جي دبليو إف™'
    ]
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Indian 2 (2024) | JWF™</title>

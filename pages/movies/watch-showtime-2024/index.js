...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://justwatchfree.vercel.app/movies/watch-showtime-2024',
    name: 'Watch Movie Showtime (2024) | JWF™',
    alternateName: [
      'Ver película Showtime (2024) | JWF™',
      'Regarder le film Showtime (2024) | JWF™',
      'Film Showtime (2024) ansehen | JWF™',
      '观看电影 Showtime (2024) | JWF™',
      '映画 Showtime (2024) を見る | JWF™',
      '영화 Showtime (2024) 보기 | JWF™',
      'Assistir Filme Showtime (2024) | JWF™',
      'Guarda il film Showtime (2024) | JWF™',
      'Посмотреть фильм Showtime (2024) | JWF™',
      'مشاهدة فيلم Showtime (2024) | جي دبليو إف™'
    ]
    ,
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Showtime (2024) | JWF™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(movie => movie.id === 'INDEX33')
  return {
    props: {
      movie: selectedMovie
    }
